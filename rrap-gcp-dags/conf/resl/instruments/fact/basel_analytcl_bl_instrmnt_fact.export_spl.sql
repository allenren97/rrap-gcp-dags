...
SELECT
    ...
    j2.CCAR_F AS CCAR_F,
    fe_md.MONTH_DEF AS CONS_DFT_MTH_CNT,
...
FROM spine sp
        ...
        LEFT JOIN features.MONTH_DEF fe_md
            ON sp.BASEL_ACCT_ID = fe_md.BASEL_ACCT_ID
           AND sp.OBSN_DT = fe_md.OBSN_DT
           AND sp.SRC_SYS_CD = fe_md.SRC_SYS_CD
