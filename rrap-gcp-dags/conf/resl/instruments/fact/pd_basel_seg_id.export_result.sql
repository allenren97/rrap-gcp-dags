SELECT 
    ...
    MODEL,
    CASE
        -- in the DEV2 parquet used for RESL testing, there are accounts with BNS MOR PD as model but NULL in both seg and id for some reason.

        WHEN MODEL = 'standalone_mor_pd' AND PD_BASEL_SEG_NUM IN (1, 2, 3) THEN PD_BASEL_SEG_NUM + 16164
        WHEN MODEL = 'standalone_mor_pd' AND PD_BASEL_SEG_NUM = 99 THEN 16173
        WHEN MODEL = 'standalone_mor_pd' AND PD_BASEL_SEG_NUM = 98 THEN 16174
        ...
        WHEN MODEL = 'step_heloc_pd' AND PD_BASEL_SEG_NUM IN (1, 2, 3) THEN PD_BASEL_SEG_NUM + 16274
        WHEN MODEL = 'step_heloc_pd' AND PD_BASEL_SEG_NUM = 98 THEN 16278
        WHEN MODEL = 'step_heloc_pd' AND PD_BASEL_SEG_NUM = 99 THEN 16279

        WHEN MODEL = 'step_mor_pd' AND PD_BASEL_SEG_NUM IN (1, 2, 3, 4) THEN PD_BASEL_SEG_NUM + 16285
        WHEN MODEL = 'step_mor_pd' AND PD_BASEL_SEG_NUM = 98 THEN 16290
        WHEN MODEL = 'step_mor_pd' AND PD_BASEL_SEG_NUM = 99 THEN 16291
        ...
        WHEN MODEL = 'standalone_heloc_pd' AND PD_BASEL_SEG_NUM IN (1, 2, 3) THEN PD_BASEL_SEG_NUM + 16000
        WHEN MODEL = 'standalone_heloc_pd' AND PD_BASEL_SEG_NUM = 98 THEN 16009
        WHEN MODEL = 'standalone_heloc_pd' AND PD_BASEL_SEG_NUM = 99 THEN 16010

        WHEN MODEL = 'step_mix_pd' AND PD_BASEL_SEG_NUM IN (1, 2, 3, 4) THEN PD_BASEL_SEG_NUM + 16279
        WHEN MODEL = 'step_mix_pd' AND PD_BASEL_SEG_NUM = 98 THEN 16284
        WHEN MODEL = 'step_mix_pd' AND PD_BASEL_SEG_NUM = 99 THEN 16285
