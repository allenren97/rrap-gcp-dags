SELECT 
    ...
    MODEL,
    CASE
        WHEN MODEL = 'standalone_heloc_ead' AND EAD_BASEL_SEG_NUM IN (1, 2) THEN EAD_BASEL_SEG_NUM + 16010
        WHEN MODEL = 'standalone_heloc_ead' AND EAD_BASEL_SEG_NUM = 98 THEN 16015 
        WHEN MODEL = 'standalone_heloc_ead' AND EAD_BASEL_SEG_NUM = 99 THEN 16016 
        ...
        WHEN MODEL = 'step_heloc_ead' AND EAD_BASEL_SEG_NUM IN (1, 2, 3) THEN EAD_BASEL_SEG_NUM + 16269
        WHEN MODEL = 'step_heloc_ead' AND EAD_BASEL_SEG_NUM = 98 THEN 16273 
        WHEN MODEL = 'step_heloc_ead' AND EAD_BASEL_SEG_NUM = 99 THEN 16274
