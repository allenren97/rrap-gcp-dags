...
part1 AS MATERIALIZED (
    SELECT
        ...
        j2.CCAR_F AS CCAR_F,
        j3.CONS_DFT_MTH_CNT AS CONS_DFT_MTH_CNT,
    ...
    FROM spine sp
        ...
        LEFT JOIN instruments.CONS_DFT_MTH_CNT j3
        ON sp.BASEL_ACCT_ID = j3.BASEL_ACCT_ID
        AND sp.OBSN_DT = j3.OBSN_DT
        AND sp.STREAM = j3.STREAM
...
part2 AS MATERIALIZED (
    ...
    FROM part1 part1
        ...
        ON part1.BASEL_ACCT_ID = j21.BASEL_ACCT_ID
        AND part1.OBSN_DT = j21.OBSN_DT
        AND part1.STREAM = j21.STREAM
        LEFT JOIN instruments.EAD_SEG_VER j22
        ON part1.BASEL_ACCT_ID = j22.BASEL_ACCT_ID
        AND part1.OBSN_DT = j22.OBSN_DT
        AND part1.STREAM = j22.STREAM
        LEFT JOIN instruments.EAD_UNADJUSTED_RPTG_RTO j23
        ON part1.BASEL_ACCT_ID = j23.BASEL_ACCT_ID
        AND part1.OBSN_DT = j23.OBSN_DT
        AND part1.STREAM = j23.STREAM
        LEFT JOIN instruments.EXPOSURE j24
        ON part1.BASEL_ACCT_ID = j24.BASEL_ACCT_ID
        AND part1.OBSN_DT = j24.OBSN_DT
        AND part1.STREAM = j24.STREAM
        LEFT JOIN instruments.EXPOSURE_SECURED j25
        ON part1.BASEL_ACCT_ID = j25.BASEL_ACCT_ID
        AND part1.OBSN_DT = j25.OBSN_DT
        AND part1.STREAM = j25.STREAM
        LEFT JOIN instruments.EXPOSURE_SECURED_MAXIMUM j26
        ON part1.BASEL_ACCT_ID = j26.BASEL_ACCT_ID
        AND part1.OBSN_DT = j26.OBSN_DT
        AND part1.STREAM = j26.STREAM
        LEFT JOIN instruments.EXPOSURE_UNSECURED j27
        ON part1.BASEL_ACCT_ID = j27.BASEL_ACCT_ID
        AND part1.OBSN_DT = j27.OBSN_DT
        AND part1.STREAM = j27.STREAM
        LEFT JOIN instruments.EXPSR_AT_DFT_RTO j28
        ON part1.BASEL_ACCT_ID = j28.BASEL_ACCT_ID
        AND part1.OBSN_DT = j28.OBSN_DT
        AND part1.STREAM = j28.STREAM
        LEFT JOIN instruments.FULLY_SECURED_F j29
        ON part1.BASEL_ACCT_ID = j29.BASEL_ACCT_ID
        AND part1.OBSN_DT = j29.OBSN_DT
        AND part1.STREAM = j29.STREAM
        LEFT JOIN instruments.INDEXED_CCLTV_RTO j30
        ON part1.BASEL_ACCT_ID = j30.BASEL_ACCT_ID
        AND part1.OBSN_DT = j30.OBSN_DT
        AND part1.STREAM = j30.STREAM
        LEFT JOIN instruments.INDEXED_PRPTY_VAL_AMT j31
        ON part1.BASEL_ACCT_ID = j31.BASEL_ACCT_ID
        AND part1.OBSN_DT = j31.OBSN_DT
        AND part1.STREAM = j31.STREAM
        LEFT JOIN instruments.INDEX_TERANETV_CMA j32
        ON part1.BASEL_ACCT_ID = j32.BASEL_ACCT_ID
        AND part1.OBSN_DT = j32.OBSN_DT
        AND part1.STREAM = j32.STREAM
        LEFT JOIN instruments.INSUR_F j33
        ON part1.BASEL_ACCT_ID = j33.BASEL_ACCT_ID
        AND part1.OBSN_DT = j33.OBSN_DT
        AND part1.STREAM = j33.STREAM
        LEFT JOIN instruments.INTR_ACCR_AMT j34
        ON part1.BASEL_ACCT_ID = j34.BASEL_ACCT_ID
        AND part1.OBSN_DT = j34.OBSN_DT
        AND part1.STREAM = j34.STREAM
        LEFT JOIN instruments.LGD_ACCT_SCORE j35
        ON part1.BASEL_ACCT_ID = j35.BASEL_ACCT_ID
        AND part1.OBSN_DT = j35.OBSN_DT
        AND part1.STREAM = j35.STREAM
        LEFT JOIN instruments.LGD_BASEL_SEG_NUM j36
        ON part1.BASEL_ACCT_ID = j36.BASEL_ACCT_ID
        AND part1.OBSN_DT = j36.OBSN_DT
        AND part1.STREAM = j36.STREAM
        LEFT JOIN instruments.LGD_FINAL_RPTG_RTO j37
        ON part1.BASEL_ACCT_ID = j37.BASEL_ACCT_ID
        AND part1.OBSN_DT = j37.OBSN_DT
        AND part1.STREAM = j37.STREAM
        LEFT JOIN instruments.LGD_FLR j38
        ON part1.BASEL_ACCT_ID = j38.BASEL_ACCT_ID
        AND part1.OBSN_DT = j38.OBSN_DT
        AND part1.STREAM = j38.STREAM
        LEFT JOIN instruments.LGD_FLRD_RPTG_RTO j39
        ON part1.BASEL_ACCT_ID = j39.BASEL_ACCT_ID
        AND part1.OBSN_DT = j39.OBSN_DT
        AND part1.STREAM = j39.STREAM
        LEFT JOIN instruments.LGD_LD_PV_AD_SV_DT_RPTG_RTO j40
        ON part1.BASEL_ACCT_ID = j40.BASEL_ACCT_ID
        AND part1.OBSN_DT = j40.OBSN_DT
        AND part1.STREAM = j40.STREAM
        LEFT JOIN instruments.LGD_LD_PV_AD_SV_RPTG_RTO j41
        ON part1.BASEL_ACCT_ID = j41.BASEL_ACCT_ID
        AND part1.OBSN_DT = j41.OBSN_DT
        AND part1.STREAM = j41.STREAM
),
part3 AS MATERIALIZED (
    SELECT
        part2.*,
    ...
    FROM part2 part2
        ...
        ON part2.BASEL_ACCT_ID = j42.BASEL_ACCT_ID
        AND part2.OBSN_DT = j42.OBSN_DT
        AND part2.STREAM = j42.STREAM
        LEFT JOIN instruments.LGD_LR_PV_AD_SV_DT_AA_RTO j43
        ON part2.BASEL_ACCT_ID = j43.BASEL_ACCT_ID
        AND part2.OBSN_DT = j43.OBSN_DT
        AND part2.STREAM = j43.STREAM
        LEFT JOIN instruments.LGD_LR_PV_RPTG_RTO j44
        ON part2.BASEL_ACCT_ID = j44.BASEL_ACCT_ID
        AND part2.OBSN_DT = j44.OBSN_DT
        AND part2.STREAM = j44.STREAM
        LEFT JOIN instruments.LGD_LR_RPTG_RTO j45
        ON part2.BASEL_ACCT_ID = j45.BASEL_ACCT_ID
        AND part2.OBSN_DT = j45.OBSN_DT
        AND part2.STREAM = j45.STREAM
        LEFT JOIN instruments.LGD_MODEL_NM j46
        ON part2.BASEL_ACCT_ID = j46.BASEL_ACCT_ID
        AND part2.OBSN_DT = j46.OBSN_DT
        AND part2.STREAM = j46.STREAM
        LEFT JOIN instruments.LGD_MODEL_VER j47
        ON part2.BASEL_ACCT_ID = j47.BASEL_ACCT_ID
        AND part2.OBSN_DT = j47.OBSN_DT
        AND part2.STREAM = j47.STREAM
        LEFT JOIN instruments.LGD_SEG_VER j48
        ON part2.BASEL_ACCT_ID = j48.BASEL_ACCT_ID
        AND part2.OBSN_DT = j48.OBSN_DT
        AND part2.STREAM = j48.STREAM
        LEFT JOIN instruments.LGD_UNADJUSTED_RPTG_RTO j49
        ON part2.BASEL_ACCT_ID = j49.BASEL_ACCT_ID
        AND part2.OBSN_DT = j49.OBSN_DT
        AND part2.STREAM = j49.STREAM
        LEFT JOIN instruments.LNG_RUN_LGD_ADD_ON_RTO j50
        ON part2.BASEL_ACCT_ID = j50.BASEL_ACCT_ID
        AND part2.OBSN_DT = j50.OBSN_DT
        AND part2.STREAM = j50.STREAM
        LEFT JOIN instruments.METRPL_AREA_NM j51
        ON part2.BASEL_ACCT_ID = j51.BASEL_ACCT_ID
        AND part2.OBSN_DT = j51.OBSN_DT
        AND part2.STREAM = j51.STREAM
        LEFT JOIN instruments.NCR_PD_BAND_KEY_VAL j52
        ON part2.BASEL_ACCT_ID = j52.BASEL_ACCT_ID
        AND part2.OBSN_DT = j52.OBSN_DT
        AND part2.STREAM = j52.STREAM
        LEFT JOIN instruments.PD_90_DAY_F j53
        ON part2.BASEL_ACCT_ID = j53.BASEL_ACCT_ID
        AND part2.OBSN_DT = j53.OBSN_DT
        AND part2.STREAM = j53.STREAM
        LEFT JOIN instruments.PD_ACCT_SCORE j54
        ON part2.BASEL_ACCT_ID = j54.BASEL_ACCT_ID
        AND part2.OBSN_DT = j54.OBSN_DT
        AND part2.STREAM = j54.STREAM
        LEFT JOIN instruments.PD_BAND j55
        ON part2.BASEL_ACCT_ID = j55.BASEL_ACCT_ID
        AND part2.OBSN_DT = j55.OBSN_DT
        AND part2.STREAM = j55.STREAM
        LEFT JOIN instruments.PD_BASEL_SEG_NUM j56
        ON part2.BASEL_ACCT_ID = j56.BASEL_ACCT_ID
        AND part2.OBSN_DT = j56.OBSN_DT
        AND part2.STREAM = j56.STREAM
        LEFT JOIN instruments.PD_FINAL_RPTG_RTO j57
        ON part2.BASEL_ACCT_ID = j57.BASEL_ACCT_ID
        AND part2.OBSN_DT = j57.OBSN_DT
        AND part2.STREAM = j57.STREAM
        LEFT JOIN instruments.PD_FLR j58
        ON part2.BASEL_ACCT_ID = j58.BASEL_ACCT_ID
        AND part2.OBSN_DT = j58.OBSN_DT
        AND part2.STREAM = j58.STREAM
        LEFT JOIN instruments.PD_FLRD_RPTG_RTO j59
        ON part2.BASEL_ACCT_ID = j59.BASEL_ACCT_ID
        AND part2.OBSN_DT = j59.OBSN_DT
        AND part2.STREAM = j59.STREAM
        LEFT JOIN instruments.PD_LD_PV_AD_SV_RPTG_RTO j60
        ON part2.BASEL_ACCT_ID = j60.BASEL_ACCT_ID
        AND part2.OBSN_DT = j60.OBSN_DT
        AND part2.STREAM = j60.STREAM
        LEFT JOIN instruments.PD_LR_PV_AD_RPTG_RTO j61
        ON part2.BASEL_ACCT_ID = j61.BASEL_ACCT_ID
        AND part2.OBSN_DT = j61.OBSN_DT
        AND part2.STREAM = j61.STREAM
        LEFT JOIN instruments.PD_LR_PV_AD_SV_DT_AA_RTO j62
        ON part2.BASEL_ACCT_ID = j62.BASEL_ACCT_ID
        AND part2.OBSN_DT = j62.OBSN_DT
        AND part2.STREAM = j62.STREAM
),
part4 AS MATERIALIZED (
    SELECT
        part3.*,
    ...
    FROM part3 part3
        ...
        ON part3.BASEL_ACCT_ID = j63.BASEL_ACCT_ID
        AND part3.OBSN_DT = j63.OBSN_DT
        AND part3.STREAM = j63.STREAM
        LEFT JOIN instruments.PD_LR_RPTG_RTO j64
        ON part3.BASEL_ACCT_ID = j64.BASEL_ACCT_ID
        AND part3.OBSN_DT = j64.OBSN_DT
        AND part3.STREAM = j64.STREAM
        LEFT JOIN instruments.PD_MODEL_NM j65
        ON part3.BASEL_ACCT_ID = j65.BASEL_ACCT_ID
        AND part3.OBSN_DT = j65.OBSN_DT
        AND part3.STREAM = j65.STREAM
        LEFT JOIN instruments.PD_MODEL_VER j66
        ON part3.BASEL_ACCT_ID = j66.BASEL_ACCT_ID
        AND part3.OBSN_DT = j66.OBSN_DT
        AND part3.STREAM = j66.STREAM
        LEFT JOIN instruments.PD_SEG_VER j67
        ON part3.BASEL_ACCT_ID = j67.BASEL_ACCT_ID
        AND part3.OBSN_DT = j67.OBSN_DT
        AND part3.STREAM = j67.STREAM
        LEFT JOIN instruments.PD_UNADJUSTED_RPTG_RTO j68
        ON part3.BASEL_ACCT_ID = j68.BASEL_ACCT_ID
        AND part3.OBSN_DT = j68.OBSN_DT
        AND part3.STREAM = j68.STREAM
        LEFT JOIN instruments.PMI_LGD_INSURED_RPTG_RTO j69
        ON part3.BASEL_ACCT_ID = j69.BASEL_ACCT_ID
        AND part3.OBSN_DT = j69.OBSN_DT
        AND part3.STREAM = j69.STREAM
        LEFT JOIN instruments.PMI_LGD_UNADJUSTED_RPTG_RTO j70
        ON part3.BASEL_ACCT_ID = j70.BASEL_ACCT_ID
        AND part3.OBSN_DT = j70.OBSN_DT
        AND part3.STREAM = j70.STREAM
        LEFT JOIN instruments.PREV_12_QTR_PRPTY_VAL_AMT j71
        ON part3.BASEL_ACCT_ID = j71.BASEL_ACCT_ID
        AND part3.OBSN_DT = j71.OBSN_DT
        AND part3.STREAM = j71.STREAM
        LEFT JOIN instruments.PRE_INSURANCE_LGD j72
        ON part3.BASEL_ACCT_ID = j72.BASEL_ACCT_ID
        AND part3.OBSN_DT = j72.OBSN_DT
        AND part3.STREAM = j72.STREAM
        LEFT JOIN instruments.PRPTY_VAL_CORR_PCTG j73
        ON part3.BASEL_ACCT_ID = j73.BASEL_ACCT_ID
        AND part3.OBSN_DT = j73.OBSN_DT
        AND part3.STREAM = j73.STREAM
        LEFT JOIN instruments.RESIDUAL_MAT j74
        ON part3.BASEL_ACCT_ID = j74.BASEL_ACCT_ID
        AND part3.OBSN_DT = j74.OBSN_DT
        AND part3.STREAM = j74.STREAM
        LEFT JOIN instruments.RNTL_PRPTY_F j75
        ON part3.BASEL_ACCT_ID = j75.BASEL_ACCT_ID
        AND part3.OBSN_DT = j75.OBSN_DT
        AND part3.STREAM = j75.STREAM
        LEFT JOIN instruments.UNDRAWN j76
        ON part3.BASEL_ACCT_ID = j76.BASEL_ACCT_ID
        AND part3.OBSN_DT = j76.OBSN_DT
        AND part3.STREAM = j76.STREAM
        LEFT JOIN instruments.UNINSURED_DLGD_RTO j77
        ON part3.BASEL_ACCT_ID = j77.BASEL_ACCT_ID
        AND part3.OBSN_DT = j77.OBSN_DT
        AND part3.STREAM = j77.STREAM
        LEFT JOIN instruments.UNINSURED_FLRD_LGD_RTO j78
        ON part3.BASEL_ACCT_ID = j78.BASEL_ACCT_ID
        AND part3.OBSN_DT = j78.OBSN_DT
        AND part3.STREAM = j78.STREAM
        LEFT JOIN instruments.UNINSURED_LGD_RTO j79
        ON part3.BASEL_ACCT_ID = j79.BASEL_ACCT_ID
        AND part3.OBSN_DT = j79.OBSN_DT
        AND part3.STREAM = j79.STREAM
        LEFT JOIN instruments.UNINSURED_LGD_SEG_NUM j80
        ON part3.BASEL_ACCT_ID = j80.BASEL_ACCT_ID
        AND part3.OBSN_DT = j80.OBSN_DT
        AND part3.STREAM = j80.STREAM
        LEFT JOIN instruments.WEIGHT_SECURED j81
        ON part3.BASEL_ACCT_ID = j81.BASEL_ACCT_ID
        AND part3.OBSN_DT = j81.OBSN_DT
        AND part3.STREAM = j81.STREAM
        LEFT JOIN instruments.WEIGHT_UNSECURED j82
        ON part3.BASEL_ACCT_ID = j82.BASEL_ACCT_ID
        AND part3.OBSN_DT = j82.OBSN_DT
        AND part3.STREAM = j82.STREAM
),
part5 AS MATERIALIZED (
    SELECT
        part4.*,
    ...
    FROM part4 part4
        ...
        ON part4.BASEL_ACCT_ID = fe_mn.BASEL_ACCT_ID
        AND part4.OBSN_DT = fe_mn.OBSN_DT
        AND part4.SRC_SYS_CD = fe_mn.SRC_SYS_CD
        LEFT JOIN features.TRANSACTOR_FLAG_QRR fe_tf
        ON part4.BASEL_ACCT_ID = fe_tf.BASEL_ACCT_ID
        AND part4.OBSN_DT = fe_tf.OBSN_DT
        LEFT JOIN features.CMHC_F fe_cm
        ON part4.BASEL_ACCT_ID = fe_cm.BASEL_ACCT_ID
        AND part4.OBSN_DT = fe_cm.OBSN_DT
        LEFT JOIN features.DRAWN fe_dr
        ON part4.BASEL_ACCT_ID = fe_dr.BASEL_ACCT_ID
        AND part4.OBSN_DT = fe_dr.OBSN_DT
)
SELECT
    part5.OBSN_DT,
    part5.STREAM,
    ...
    part5.PIT_STAT_CD,
    part5.AMORT,
    part5.CCAR_BASEL_PRD_TP_NM,
    part5.CCAR_F,
    part5.CONS_DFT_MTH_CNT,
    part5.CRNT_LTV_RTO,
    part5.CRNT_PRPTY_VAL_AMT,
    part5.DLGD_F,
    part5.DLGD_FLR,
    part5.DLGD_RPTG_RTO,
    part5.EAD_ACCT_SCORE,
    part5.EAD_BASEL_SEG_NUM,
    part5.EAD_FINAL_RPTG_RTO,
    part5.EAD_FLR,
    part5.EAD_FLRD_RPTG_RTO,
    part5.EAD_LD_PV_AD_SV_DT_RPTG_RTO,
    part5.EAD_LD_PV_AD_SV_RPTG_RTO,
    part5.EAD_LR_PV_AD_RPTG_RTO,
    part5.EAD_LR_PV_AD_SV_DT_AA_RTO,
    part5.EAD_LR_PV_RPTG_RTO,
    part5.EAD_LR_RPTG_RTO,
    part5.EAD_MODEL_NM,
    part5.EAD_MODEL_VER,
    part5.EAD_SEG_VER,
    part5.EAD_UNADJUSTED_RPTG_RTO,
    part5.EXPOSURE,
    part5.EXPOSURE_SECURED,
    part5.EXPOSURE_SECURED_MAXIMUM,
    part5.EXPOSURE_UNSECURED,
    part5.EXPSR_AT_DFT_RTO,
    part5.FULLY_SECURED_F,
    part5.INDEXED_LOAN_TO_VAL_RTO,
    part5.INDEXED_PRPTY_VAL_AMT,
    part5.MORT_NUM,
    part5.INDEX_TERANETV,
    part5.INSUR_F,
    part5.INTR_ACCR_AMT,
    part5.LGD_ACCT_SCORE,
    part5.LGD_BASEL_SEG_NUM,
    part5.LGD_FINAL_RPTG_RTO,
    part5.LGD_FLR,
    part5.LGD_FLRD_RPTG_RTO,
    part5.LGD_LD_PV_AD_SV_DT_RPTG_RTO,
    part5.LGD_LD_PV_AD_SV_RPTG_RTO,
    part5.LGD_LR_PV_AD_RPTG_RTO,
    part5.LGD_LR_PV_AD_SV_DT_AA_RTO,
    part5.LGD_LR_PV_RPTG_RTO,
    part5.LGD_LR_RPTG_RTO,
    part5.LGD_MODEL_NM,
    part5.LGD_MODEL_VER,
    part5.LGD_SEG_VER,
    part5.LGD_UNADJUSTED_RPTG_RTO,
    part5.LNG_RUN_LGD_ADD_ON_RTO,
    part5.METRPL_AREA_NM,
    part5.NCR_PD_BAND_KEY_VAL,
    part5.PD_90_DAY_F,
    part5.PD_ACCT_SCORE,
    part5.PD_BAND,
    part5.PD_BASEL_SEG_NUM,
    part5.PD_FINAL_RPTG_RTO,
    part5.PD_FLR,
    part5.PD_FLRD_RPTG_RTO,
    part5.PD_LD_PV_AD_SV_RPTG_RTO,
    part5.PD_LR_PV_AD_RPTG_RTO,
    part5.PD_LR_PV_AD_SV_DT_AA_RTO,
    part5.PD_LR_PV_RPTG_RTO,
    part5.PD_LR_RPTG_RTO,
    part5.PD_MODEL_NM,
    part5.PD_MODEL_VER,
    part5.PD_SEG_VER,
    part5.PD_UNADJUSTED_RPTG_RTO,
    part5.PMI_LGD_INSURED_RPTG_RTO,
    part5.PMI_LGD_UNADJUSTED_RPTG_RTO,
    part5.PREV_12_QTR_PRPTY_VAL_AMT,
    part5.PRE_INSURANCE_LGD,
    part5.PRPTY_VAL_CORR_PCTG,
    part5.RESIDUAL_MAT,
    part5.RNTL_PRPTY_F,
    part5.UNDRAWN,
    part5.UNINSURED_DLGD_RTO,
    part5.UNINSURED_FLRD_LGD_RTO,
    part5.UNINSURED_LGD_RTO,
    part5.UNINSURED_LGD_SEG_NUM,
    part5.WEIGHT_SECURED,
    part5.WEIGHT_UNSECURED,
    part5.TRANSACTOR_FLAG_QRR,
    part5.CMHC_F,
    part5.DRAWN,
