WITH
        ...
        TRNSCTR_IND AS (
            SELECT
                BASEL_ACCT_ID,
                TRIM(TRNSCTR_IND) AS TRNSCTR_IND
            FROM
        ...
        FROM
            ...
            LEFT JOIN TRNSCTR_IND AS TRNSCTR_IND ON main.BASEL_ACCT_ID = TRNSCTR_IND.BASEL_ACCT_ID
        ...
        WHERE
            ...
            AND TRNSCTR_IND.TRNSCTR_IND IN ('N', 'T')
