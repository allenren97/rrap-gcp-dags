...
UPSTREAM_ASSET = ['ingestion.METRPL_CITY_LKP_CMA']
DOWNSTREAM_ASSET = "ingestion.TERANET_ADDR_LKP_CMA"
DEPENDENCIES = {
...
def duckdb_update_records_in_ducklake(
    ...
    SET EFF_TO_YR_MTH = {{{{ task_instance.xcom_pull(task_ids="handle_month_context", key="yrmth_prev") }}}}
    ,CRNT_F = 'N'  
