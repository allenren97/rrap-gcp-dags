...
DOWNSTREAM_ASSET = "features.BC33_MAX6M"
DEPENDENCIES = {
    'duckdb_clear_derive_bc33_max6m': ['duckdb_derive_bc33_max6m'],
}


def duckdb_clear_derive_bc33_max6m(
