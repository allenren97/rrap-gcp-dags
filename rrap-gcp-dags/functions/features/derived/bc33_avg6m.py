...
DOWNSTREAM_ASSET = "features.BC33_AVG6M"
DEPENDENCIES = {
    'duckdb_clear_derive_bc33avg6m': ['duckdb_derive_bc33avg6m'],
}


def duckdb_clear_derive_bc33avg6m(
