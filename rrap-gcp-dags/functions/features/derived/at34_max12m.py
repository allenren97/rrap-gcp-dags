...
DOWNSTREAM_ASSET = 'features.AT34_MAX12M'
DEPENDENCIES = {
    'duckdb_clear_at34_max12m': ['duckdb_derive_at34_max12m'],
}


def duckdb_clear_at34_max12m(
