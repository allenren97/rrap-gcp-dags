...
DOWNSTREAM_ASSET = "features.GO04_AVG6M"
DEPENDENCIES = {
    ...
    sql=f"""
        ...
        FROM (
            WITH snap AS (
                ...
                -- sum of INQRY_CNT per BASEL_CUST_ID over months that exist in 
            ...
            SELECT
                ...
                snap.BASEL_CUST_ID,
                ROUND(L15.SUM_INQRY_CNT / L26.CNT_BASEL_CUST_ID_26, 4) AS GO04_AVG6M
            FROM snap
