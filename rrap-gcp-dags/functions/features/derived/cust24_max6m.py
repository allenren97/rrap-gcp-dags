...
DOWNSTREAM_ASSET = 'features.CUST24_MAX6M'
DEPENDENCIES = {
    'duckdb_clear_cust24_max6m': ['duckdb_derive_cust24_max6m'],
}


def duckdb_clear_cust24_max6m(
...
def duckdb_derive_cust24_max6m(
    duckdb_conn_id='duckdb-conn',
    sql=rf"""
