...
DOWNSTREAM_ASSET = 'features.AT34_AVG6M'
DEPENDENCIES = {
    'duckdb_clear_at34_avg6m': ['duckdb_derive_at34_avg6m'],
}


def duckdb_clear_at34_avg6m(
