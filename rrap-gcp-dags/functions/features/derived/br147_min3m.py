...
DOWNSTREAM_ASSET = 'features.BR147_MIN3M'
DEPENDENCIES = {
    'duckdb_clear_br147_min3m': ['duckdb_derive_br147_min3m'],
}


def duckdb_clear_br147_min3m(
...
def duckdb_derive_br147_min3m(
    duckdb_conn_id='duckdb-conn',
    sql=rf"""
    INSERT INTO { DOWNSTREAM_ASSET }
    BY NAME FROM (
        select
            min(BR147) as BR147_MIN3M,
            BASEL_CUST_ID,
