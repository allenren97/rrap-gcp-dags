...
DOWNSTREAM_ASSET = "features.BC33_MAX3M"
DEPENDENCIES = {
    'duckdb_clear_derive_bc33_max3m': ['duckdb_derive_bc33_max3m'],
}


def duckdb_clear_derive_bc33_max3m(
