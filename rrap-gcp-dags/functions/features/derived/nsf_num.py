...
DOWNSTREAM_ASSET = 'features.NSF_NUM'

DEPENDENCIES = {
    'duckdb_clear_nsf_num': ['duckdb_derive_nsf_num'],
}


def duckdb_clear_nsf_num(
...
def duckdb_derive_nsf_num(
    ...
    BY NAME FROM (
        ...
        from (
            select distinct d.basel_cust_id, a.TXN_GRP_KEY_RM, b.ACCT_KEY, b.ACTY_CNT
