...
DOWNSTREAM_ASSET = "features.AT29_MAX12M"
DEPENDENCIES = {
    'duckdb_clear_derive_at29_max12m': ['duckdb_derive_at29_max12m'],
}


def duckdb_clear_derive_at29_max12m(
