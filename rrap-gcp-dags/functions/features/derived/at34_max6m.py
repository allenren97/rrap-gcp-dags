...
DOWNSTREAM_ASSET = 'features.AT34_MAX6M'
DEPENDENCIES = {
    'duckdb_clear_at34_max6m': ['duckdb_derive_at34_max6m'],
}


def duckdb_clear_at34_max6m(
