...
DOWNSTREAM_ASSET = 'features.TOT_PAYRL_AMT_MIN3M'
DEPENDENCIES = {
    'duckdb_clear_tot_payrl_amt_min3m': ['duckdb_derive_tot_payrl_amt_min3m'],
}


def duckdb_clear_tot_payrl_amt_min3m(
...
def duckdb_derive_tot_payrl_amt_min3m(
    duckdb_conn_id='duckdb-conn',
    sql=f"""
    ...
    SELECT
        ...
        BASEL_CUST_ID,
        MIN(TOT_PAYRL_AMT) AS TOT_PAYRL_AMT_MIN3M
