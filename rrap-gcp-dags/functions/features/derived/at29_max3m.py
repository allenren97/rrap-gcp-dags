...
DOWNSTREAM_ASSET = "features.AT29_MAX3M"
DEPENDENCIES = {
    'duckdb_clear_derive_at29_max3m': ['duckdb_derive_at29_max3m'],
}


def duckdb_clear_derive_at29_max3m(
