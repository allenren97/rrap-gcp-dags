...
DOWNSTREAM_ASSET = 'features.GO11_MIN3M'
DEPENDENCIES = {
    'duckdb_clear_go11_min3m': ['duckdb_derive_go11_min3m'],
}


def duckdb_clear_go11_min3m(
