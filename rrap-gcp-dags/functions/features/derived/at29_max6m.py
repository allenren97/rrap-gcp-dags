...
DOWNSTREAM_ASSET = "features.AT29_MAX6M"
DEPENDENCIES = {
    'duckdb_clear_derive_at29_max6m': ['duckdb_derive_at29_max6m'],
}


def duckdb_clear_derive_at29_max6m(
