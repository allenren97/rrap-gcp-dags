...
DOWNSTREAM_ASSET = "features.STEP_CR_LMT"
DEPENDENCIES = {
    ...
    sql=f"""
        ...
        FROM (
            WITH non_excl AS (
                ...
                SELECT TRIM(STEP_PLN_AGRMNT_NUM) AS STEP_PLN_AGRMNT_NUM, CR_LMT_AMT AS CR_LMT
                ...
                SELECT TRIM(STEP_PLN_AGRMNT_NUM) AS STEP_PLN_AGRMNT_NUM, TOTAL_BALANCE AS CR_LMT
                FROM non_excl
