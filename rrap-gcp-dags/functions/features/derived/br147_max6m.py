...
UPSTREAM_ASSET = [ 'features.BR147' ]
DOWNSTREAM_ASSET = 'features.BR147_MAX6M'
DEPENDENCIES = {
    'duckdb_clear_br147_max6m': ['duckdb_derive_br147_max6m'],
}


def duckdb_clear_br147_max6m(
...
def duckdb_derive_br147_max6m(
    duckdb_conn_id='duckdb-conn',
    sql=rf"""
    INSERT INTO { DOWNSTREAM_ASSET }
    BY NAME FROM (
        select
            max(BR147) as br147_max6m,
            BASEL_CUST_ID,
