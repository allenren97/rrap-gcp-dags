...
DOWNSTREAM_ASSET = "features.AT94_AVG6M"
DEPENDENCIES = {
    ...
    sql=f"""
        ...
        FROM (
            WITH snap AS (
                ...
                -- sum of TOT_AVL_CR_NOT_UTILIZED_AMT per BASEL_CUST_ID over months that exist in 
                -- BASEL_CUST_ACCT_RLTNP_SNAPSHOT within a rolling 6-month window
                SELECT
                    WSS.SUM_TOT_AVL_CR_NOT_UTILIZED_AMT,
                    NSS.BASEL_CUST_ID
                FROM (
                    SELECT
                        A.BASEL_CUST_ID,
            ...
            SELECT
                ...
                snap.BASEL_CUST_ID,
                ROUND(L15.SUM_TOT_AVL_CR_NOT_UTILIZED_AMT / L26.CNT_BASEL_CUST_ID_26, 3) AS AT94_AVG6M
            FROM snap
