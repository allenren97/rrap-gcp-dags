...
DOWNSTREAM_ASSET = "features.DAY_ODUE_MAX6M"
DEPENDENCIES = {
    'duckdb_clear_derive_day_odue_max6m': ['duckdb_derive_day_odue_max6m'],
}


def duckdb_clear_derive_day_odue_max6m(
...
def duckdb_derive_day_odue_max6m(
    duckdb_conn_id='duckdb-conn',
    sql=f"""
    INSERT INTO {DOWNSTREAM_ASSET} (
        SELECT
            ...
            BASEL_ACCT_ID,
            MAX(DAY_ODUE) AS DAY_ODUE_MAX6M
