...
DOWNSTREAM_ASSET = 'features.GO06_MAX6M'
DEPENDENCIES = {
    'duckdb_clear_go06_max6m': ['duckdb_derive_go06_max6m'],
}


def duckdb_clear_go06_max6m(
