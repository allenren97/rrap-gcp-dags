...
DOWNSTREAM_ASSET = 'features.PR01_MAX6M'
DEPENDENCIES = {
    'duckdb_clear_pr01_max6m': ['duckdb_derive_pr01_max6m'],
}


def duckdb_clear_pr01_max6m(
...
def duckdb_derive_pr01_max6m(
    duckdb_conn_id='duckdb-conn',
    sql=rf"""
    INSERT INTO { DOWNSTREAM_ASSET }
    BY NAME FROM (
        select            
            max(PR01) as PR01_MAX6M,
            BASEL_CUST_ID,
