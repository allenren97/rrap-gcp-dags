...
DOWNSTREAM_ASSET = 'features.GO04_MAX6M'
DEPENDENCIES = {
    'duckdb_clear_go04_max6m': ['duckdb_derive_go04_max6m'],
}


def duckdb_clear_go04_max6m(
...
def duckdb_derive_go04_max6m(
    duckdb_conn_id='duckdb-conn',
    sql=f"""
    INSERT INTO { DOWNSTREAM_ASSET }
    BY NAME FROM (
        select
            max(GO04) as go04_max6m,
            BASEL_CUST_ID,
