...
DOWNSTREAM_ASSET = f"reference.RMA_BASEL3_PRDCT_SCHD_BCAR50_LKP"
DEPENDENCIES = {
    'sensor_wait_for_table': ['duckdb_delete'],
    'duckdb_delete' : ['duckdb_load'],
    'duckdb_load': ['outlet_lkp']
}
INPUT_PATH = 'RMA_BASEL3_PRDCT_SCHD_BCAR50_LKP.parquet'
...
def duckdb_load(
    ...
    sql=f"""
        ...
        FROM (
            SELECT * FROM '{{{{ task_instance.xcom_pull(task_ids="sensor_wait_for_table", key="parquet") }}}}'
        )
    """
):
    pass
