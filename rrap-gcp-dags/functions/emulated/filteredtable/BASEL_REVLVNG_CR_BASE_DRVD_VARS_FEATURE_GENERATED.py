...
Builds emulated.BASEL_REVLVNG_CR_BASE_DRVD_VARS_FEATURE_GENERATED:
  export_result — snapshot + features.*
  duckdb_load   — insert into DuckLake

PIT_STAT_VER_2_CD = features.PIT_STATUS_CROSS_DEFAULT_ORIG (final PIT after cross-default).
PIT_STAT_VER_2_CD90 / CD180 retained as separate feature columns.
"""
