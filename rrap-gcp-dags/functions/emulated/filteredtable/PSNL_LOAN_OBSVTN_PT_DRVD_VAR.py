...
Builds emulated.PSNL_LOAN_OBSVTN_PT_DRVD_VAR for the current process month as a
thin join over the observation-point features. The LGDD/LGDND window derivation
now lives in the features (LAST_NEW_DFT_DT, LAST_NEW_DFT_BAL_AMT, MODEL_DFT_F),
so this table just projects them keyed by BASEL_ACCT_ID + OBSVTN_MTH_TM_ID.
"""
