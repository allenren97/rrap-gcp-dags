...
Two month ids, matching production (SAS OBSVTN_MTH_TM_ID vs PROCESS_MTH_TM_ID;
delete keyed by process_mth_tm_id = &mth_tm_id):
  PROCESS_MTH_TM_ID / PROCESS_DATE  = the RUN month R (delete/replace key)
  OBSVTN_MTH_TM_ID                  = the OBSERVATION month = R - 12 months
                                      (CUR observation; 40 tm_id = 1 month)
