...
DOWNSTREAM_ASSET = "instruments.EAD_LR_PV_AD_SV_DT_AA_RTO"
DEPENDENCIES = {
    ...
    FROM (
        WITH
            ...
            SELECT DISTINCT
                ...
                CASE 
                    WHEN TRIM(acct.SRC_SYS_CD) = 'KS' THEN LR_PV_AD_SV_DT_AA_RTO 
                    ELSE 0
                END AS EAD_LR_PV_AD_SV_DT_AA_RTO
