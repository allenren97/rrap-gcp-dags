...
DOWNSTREAM_ASSET = "instruments.EAD_LD_PV_AD_SV_RPTG_RTO"
DEPENDENCIES = {
    ...
    FROM (
        WITH
            ...
            SELECT DISTINCT
                ...
                CASE 
                    WHEN TRIM(acct.SRC_SYS_CD) = 'KS' THEN LR_PV_AD_SV_RTO 
                    ELSE 0
                END AS EAD_LD_PV_AD_SV_RPTG_RTO
