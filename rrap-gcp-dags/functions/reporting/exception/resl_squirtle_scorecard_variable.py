...
REPORT_NAME = 'resl_squirtle_scorecard_variable_report.xlsx'
UPSTREAM_ASSET = [ "models.step_mix_pd_score",
                    "models.standalone_heloc_pd_score",
                    "models.standalone_mor_pd_score",
                    "models.step_heloc_ead_score",
                    "models.step_heloc_pd_score",
                    "models.step_mix_mor_lgdd_score",
                    "models.step_mix_mor_lgdnd_score",
                    "models.step_mor_pd_score",
]
...
def generate_report(pool="duckdb_pool", pool_slots=16):
    context = get_current_context()
    obsn_dt = context['ti'].xcom_pull(task_ids="handle_month_context", key="rundate")
    generate_scorecard_variable_report(UPSTREAM_ASSET, DOWNSTREAM_ASSET, obsn_dt)
