   ...
   %macro etls_processToLoopW2F8OD5(parameterTable=, row=, handleName=rmt);
      ...
      %macro etls_jobW2F8ODG; 
         ...
         proc sql;
             ...
             select * from connection to dbcon (
         		Select 	
         			...
         			c.time_key,
         			c.acct_bal
         		from &net_db..iwf_cust_acct as c
         		inner join &net_db..iwd_pd_pln as e on c.pd_pln_key = e.pd_pln_key
         ...
         proc sql;
             ...
             select * from connection to dbcon (
         		select cust_base_key, CUST_ID from &net_db..cust_xref group by cust_base_key, CUST_ID
         		);
         quit;
...
/*         quit;	*/
         ...
         set
         		...
         		,SRC_OBJ_NM = '&net_db..iwf_cust_acct'
