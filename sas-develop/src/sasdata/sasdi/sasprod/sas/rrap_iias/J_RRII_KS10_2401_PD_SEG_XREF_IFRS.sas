/**************************************************************************** 
 * Job:             J_RRAP_KS10_2401_PD_SEG_ACCT_XREF_IFRS     A57SWEI7.BH0009I0 * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                                                                          * 
 * Generated on:    Thursday, June 29, 2017 2:36:35 PM EDT                  * 
...
%let etls_jobName = %nrquote(J_RRAP_KS10_2401_PD_SEG_ACCT_XREF_IFRS);
...
%macro etls_loopW2F4OGC; 
   ...
   %macro etls_processToLoopW2F4OGM(parameterTable=, row=, handleName=rmt);
      ...
      %macro etls_jobW2F4OGW; 
         ...
         /*==========================================================================* 
          * Step:            RRAP_DM_INS_PD_SEG_ACCT_XREF_IFRS          A57SWEI7.BK000YSS * 
          * Transform:       User Written                                            * 
          * Description:                                                             * 
          *                                                                          * 
         ...
         %etl_job_start(TARGET_TABLE=NETCON.PD_SEG_ACCT_XREF_IFRS);
         ...
         EXECUTE(DELETE FROM &net_db..PD_SEG_ACCT_XREF_IFRS WHERE MTH_TM_ID=&TM_DIM_ID) BY NZCON1;
         QUIT;
         ...
         /*	BELOW QUERY CHANGED DUE TO REQUIREMENT AS PART OF Q4 PHASE - SEP162015*/
         	...
         	Proc sql;
         			...
         			insert into NETCON.PD_SEG_ACCT_XREF_IFRS (
         				 BASEL_ACCT_ID
         		       , MTH_TM_ID
         		       , BASEL_SEG_ID
         			   , BASEL_MODEL_REL_ID
         ...
         /**  Step end RRAP_DM_INS_PD_SEG_ACCT_XREF_IFRS **/
