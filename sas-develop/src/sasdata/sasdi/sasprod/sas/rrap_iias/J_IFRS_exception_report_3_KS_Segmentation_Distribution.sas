...
%let file_name_tl =IFRS9_PLL_TL_Segmentation_Distribution_&file_name_date..xls;
%let file_name_ks =IFRS9_PLL_KS_Segmentation_Distribution_&file_name_date..xls;
%let file_name_mor =IFRS9_PLL_BNS_TNG Segmentation_Distribution_&file_name_date..xls;
...
%PUT IFRS9 Parallel SC: RRAP Exception report 3 - Start Time     : %Sysfunc(PutN(&datetime_start.,datetime18.));
%PUT IFRS9 Parallel SC: RRAP Exception report 3 - END TIME       : %sysfunc(datetime(),datetime18.);;
%put IFRS9 Parallel SC: RRAP Exception report 3 - PROCESSING TIME:  %sysfunc(putn(%sysevalf(%sysfunc(TIME())-&datetime_start.),mmss.));
