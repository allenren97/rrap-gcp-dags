 ...
 *                                                                          * 
 * Generated on:    Thursday, March 22, 2018 2:03:11 PM EDT                 * 
...
%let jobID = %quote(A57SWEI7.BH000AEG);
%let etls_jobName = %nrquote(J_rrap_exception_report_2_MOR_Scorecard_Distribution);
...
/*==========================================================================* 
 * Step:            rrap_exception_report_autoexec        A57SWEI7.BK0011WL * 
 * Transform:       AM_rrap_exception_report_autoexec                       * 
 * Description:                                                             * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK0011WL);
%let trans_rc = 0;
...
/*19MAR2018 - join Base to Current*/
...
line "BNS/TNG MOR Scorecard Distribution &file_name_date - SI above threshold";
endcomp;
run;
...
compute before _PAGE_;
line "BNS/TNG MOR Scorecard Distribution &file_name_date";
endcomp;
run;
proc report data=work.legend split='~' missing  noheader
;
...
SUBJECT= "[RRAP] SI above threshold for BNS/TNG MOR Scorecard Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&si_email_list);
     put;
...
%else %do;
FILENAME OUTMAIL EMAIL ATTACH=("&file_path.&file_name_mor")
SUBJECT= "[RRAP] BNS/TNG MOR Scorecard Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&email_list);
...
%PUT RRAP Exception report 2 - MOR Start Time: %Sysfunc(PutN(&datetime_start.,datetime18.));
