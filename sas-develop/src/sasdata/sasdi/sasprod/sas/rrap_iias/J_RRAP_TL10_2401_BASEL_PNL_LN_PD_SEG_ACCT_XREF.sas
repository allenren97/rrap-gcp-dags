/**************************************************************************** 
 * Job:             J_RRAP_TL10_2401_BASEL_PNL_LN_PD_SEG  A57SWEI7.BH0009IQ * 
 *                  _ACCT_XREF                                              * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 * Target Tables:   BASEL_PNL_LN_PD_SEG_ACCT_XREF -       A57SWEI7.BE000442 * 
 *                   NZRRAP.BASEL_PNL_LN_PD_SEG_ACCT_XREF                   * 
 *                  BASEL_PNL_LN_PD_SEG_ACCT_XREF -       A57SWEI7.BE000442 * 
 *                   NZRRAP.BASEL_PNL_LN_PD_SEG_ACCT_XREF                   * 
 *                                                                          * 
 * Generated on:    Thursday, June 29, 2017 2:40:06 PM EDT                  * 
...
%let etls_jobName = %nrquote(J_RRAP_TL10_2401_BASEL_PNL_LN_PD_SEG_ACCT_XREF);
...
%macro etls_loopW2GDVQS; 
   ...
   %macro etls_processToLoopW2GDVR2(parameterTable=, row=, handleName=rmt);
      ...
      %macro etls_jobW2GDVRC; 
         ...
         %let MODULE=TL;
         %let BATCH=2.4;
         %etl_job_start(TARGET_TABLE=NZRRAP.BASEL_PNL_LN_PD_SEG_ACCT_XREF);
         ...
         %macro etls_sql_delete;
            ...
            %let etls_tableExist = %eval(%sysfunc(exist(NZRRAP.BASEL_PNL_LN_PD_SEG_ACCT_XREF, DATA)) or 
            ...
            %do;  /* if table does not exist  */ 
               ...
               data NZRRAP.BASEL_PNL_LN_PD_SEG_ACCT_XREF
                       (dbnull = (
                                  BASEL_ACCT_ID = NO
                                  MTH_TM_ID = NO
                                  BASEL_SEG_ID = NO
            ...
            proc sql;
               delete from NZRRAP.BASEL_PNL_LN_PD_SEG_ACCT_XREF
               where
                  BASEL_PNL_LN_PD_SEG_ACCT_XREF.MTH_TM_ID = &DEL_MTH_TM_ID
            ;quit;
         ...
         %macro etls_loader;
            ...
            %let etls_tableExist = %eval(%sysfunc(exist(NZRRAP."BASEL_PNL_LN_PD_SEG_ACCT_XREF"n, DATA)) or 
                  %sysfunc(exist(NZRRAP."BASEL_PNL_LN_PD_SEG_ACCT_XREF"n, VIEW))); 
            ...
            %do;  /* if table does not exist  */ 
               ...
               data NZRRAP."BASEL_PNL_LN_PD_SEG_ACCT_XREF"n
                       (dbnull = (
                                  "BASEL_ACCT_ID"n = NO
                                  "MTH_TM_ID"n = NO
                                  "BASEL_SEG_ID"n = NO
            ...
            proc append base = NZRRAP."BASEL_PNL_LN_PD_SEG_ACCT_XREF"n (BULKLOAD=YES BL_METHOD=CLILOAD)
         ...
         %let etls_recnt = 0;
         %macro etls_recordCheck; 
            %let etls_recCheckExist = %eval(%sysfunc(exist(NZRRAP."BASEL_PNL_LN_PD_SEG_ACCT_XREF"n, DATA)) or 
                  %sysfunc(exist(NZRRAP."BASEL_PNL_LN_PD_SEG_ACCT_XREF"n, VIEW))); 
            
            %if (&etls_recCheckExist) %then
            %do;
               proc sql noprint;
                  select count(*) into :etls_recnt from NZRRAP."BASEL_PNL_LN_PD_SEG_ACCT_XREF"n;
               quit;
            %end;
         %mend etls_recordCheck;
         %etls_recordCheck;
