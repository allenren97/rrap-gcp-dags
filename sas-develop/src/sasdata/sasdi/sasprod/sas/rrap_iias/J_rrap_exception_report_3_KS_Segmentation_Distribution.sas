/**************************************************************************** 
 * Job:             J_rrap_exception_report_3_KS_Segment  A57SWEI7.BH000AEI * 
 *                  ation_Distribution                                      * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                                                                          * 
 * Generated on:    Thursday, March 22, 2018 2:03:13 PM EDT                 * 
...
%let etls_jobName = %nrquote(J_rrap_exception_report_3_KS_Segmentation_Distribution);
...
/* for report 1 SPL, KS  
libname NZRRAP netezza server = cs2iwntzp01 database = EDRTLRP1D_IC  user=owprdsas pwd="{SAS002}0F833D4941CA4F644D8724214AE838AC3F916580";

/* for report 1 MOR  */
/*LIBNAME FRG NETEZZA SERVER=cs2iwntzp01 DATABASE=FRG_USER_DATA authdomain="NZ_Auth" bulkunload=yes ;
LIBNAME FRG NETEZZA SERVER=cs2iwntzp01 DATABASE=FRG_USER_DATA_IC  user=owprdsas pwd="{SAS002}0F833D4941CA4F644D8724214AE838AC3F916580";
...
/* for report 3 
LIBNAME DM1P1D DB2 DATABASE="DM1D1D" SCHEMA="EDRRAP" user=owprdsas pwd="{SAS002}5BC89D53059BB20411C79D78391ED7260C683AC9"; */
...
(
SELECT TABLENAME,createdate FROM _V_TABLE where objtype = 'TABLE' and
...
/**this calculates the SI using 201510 as the base;*/
/**comparing the shift in SI, based on the 9 segments;*/
...
line "KS Segmentation Distribution &file_name_date - SI above threshold";
endcomp;
run;
...
compute before _PAGE_;
line "KS Segmentation Distribution &file_name_date";
endcomp;
run;
proc report data=work.legend split='~' missing  noheader
;
...
SUBJECT= "[RRAP] SI above threshold for KS Segmentation Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&si_email_list);
     put;
...
%else %do;
FILENAME OUTMAIL EMAIL ATTACH=("&file_path.&file_name_ks")
SUBJECT= "[RRAP] KS Segmentation Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&email_list);
