/**************************************************************************** 
 * Job:             RRAP_MOR_MODEL_02_BNS_MOR_PD_G        A57SWEI7.BH0009JZ * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                                                                          * 
 * Generated on:    Thursday, June 29, 2017 2:43:50 PM EDT                  * 
...
%let jobID = %quote(A57SWEI7.BH0009JZ);
%let etls_jobName = %nrquote(RRAP_MOR_MODEL_02_BNS_MOR_PD_G);
...
/*==========================================================================* 
 * Step:            User Written                          A57SWEI7.BK000Z5I * 
 * Transform:       User Written                                            * 
 * Description:                                                             * 
 *                                                                          * 
 * Target Table:    User Written - work.W1X1MZQ4          A57SWEI7.BN000NL5 * 
 *                                                                          * 
 * User Written:    SourceCode                                              * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000Z5I);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 

%let _INPUT_count = 0;
%let _OUTPUT_count = 1;
%let _OUTPUT = work.W1X1MZQ4;
%let _OUTPUT_connect = ;
%let _OUTPUT_engine = ;
%let _OUTPUT_memtype = DATA;
%let _OUTPUT_options = %nrquote();
%let _OUTPUT_alter = %nrquote();
%let _OUTPUT_path = %nrquote(/User Written_A57SWEI7.BN000NL5%(WorkTable%));
%let _OUTPUT_type = 1;
...
%let _OUTPUT_col0_table = work.W1X1MZQ4;
...
/*==========================================================================* 
 * Step:            Loop                                  A57SWEI7.BK000Z5J * 
 * Transform:       Loop                                                    * 
 * Description:                                                             * 
 *                                                                          * 
 * Source Table:    User Written - work.W1X1MZQ4          A57SWEI7.BN000NL5 * 
 * Target Table:    Loop - work.W1X1LWVF                  A57SWEI7.BN000NL6 * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000Z5J);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
%macro etls_recordCheck; 
   %let etls_recCheckExist = %eval(%sysfunc(exist(work.W1X1MZQ4, DATA)) or 
         %sysfunc(exist(work.W1X1MZQ4, VIEW))); 
   ...
   %do;
      ...
      proc contents data = work.W1X1MZQ4 out = work.etls_contents(keep = nobs) noprint; 
      run; 
...
%let SYSLAST = %nrquote(work.W1X1MZQ4); 
...
%macro etls_loopW2HPYWS; 
   %local etls_filePrefix; 
   %let etls_filePrefix = ; 
   
   %macro etls_processToLoopW2HPYX2(parameterTable=, row=, handleName=rmt);
      ...
      rsubmit &handleName wait = no sysrputsync = yes persist = no; 
         ...
         %macro etls_jobW2HPYXC; 
            ...
            /* Setup to capture return codes  */ 
                        ...
                        %mend rcSetDS; 
                        /**************************************************************************** 
                         * Job:             RRAP_MOR_MODEL_02_BNS_MOR_PD          A57SWEI7.BH0009J8 * 
                         * Description:                                                             * 
                         *                                                                          * 
                         * Metadata Server: 10.56.70.48                                             * 
                         * Port:            8561                                                    * 
                        ...
                        /* General macro variables  */ 
                        %let jobID = %quote(A57SWEI7.BH0009J8);
                        %let etls_jobName = %nrquote(RRAP_MOR_MODEL_02_BNS_MOR_PD);
                        %let etls_userID = %nrquote(owprdsas);
                        ...
                        /*==========================================================================* 
                         * Step:            AM_rrap_mortgage_autoexec             A57SWEI7.BK000Z3H * 
                         * Transform:       AM_rrap_mor_bns_autoexec                                * 
                         * Description:     BNS Mortgage jobs imported from IW503 leverage this     * 
                         *                   transformation                                         * 
                         *==========================================================================*/ 
                        
                        %let transformID = %quote(A57SWEI7.BK000Z3H);
                        %let trans_rc = 0;
                        %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
                        ...
                        /*==========================================================================* 
                         * Step:            MODEL_2_CODE_20150115                 A57SWEI7.BK000Z3I * 
                         * Transform:       User Written                                            * 
                         * Description:                                                             * 
                         *                                                                          * 
                         * Target Table:    User Written - work.WV3GM6            A57SWEI7.BN000NPX * 
                         *                                                                          * 
                         * User Written:    SourceCode                                              * 
                         *==========================================================================*/ 
                        
                        %let transformID = %quote(A57SWEI7.BK000Z3I);
                        %let trans_rc = 0;
                        %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
                        
                        %let _INPUT_count = 0;
                        %let _OUTPUT_count = 1;
                        %let _OUTPUT = work.WV3GM6;
                        %let _OUTPUT_connect = ;
                        %let _OUTPUT_engine = ;
                        %let _OUTPUT_memtype = DATA;
                        %let _OUTPUT_options = %nrquote();
                        %let _OUTPUT_alter = %nrquote();
                        %let _OUTPUT_path = %nrquote(/User Written_A57SWEI7.BN000NPX%(WorkTable%));
                        %let _OUTPUT_type = 1;
                        %let _OUTPUT_label = %nrquote();
                        %let _OUTPUT_col_count = 0;
                        
                        %let _OUTPUT1 = work.WV3GM6;
                        %let _OUTPUT1_connect = ;
                        %let _OUTPUT1_engine = ;
                        %let _OUTPUT1_memtype = DATA;
                        %let _OUTPUT1_options = %nrquote();
                        %let _OUTPUT1_alter = %nrquote();
                        %let _OUTPUT1_path = %nrquote(/User Written_A57SWEI7.BN000NPX%(WorkTable%));
                        %let _OUTPUT1_type = 1;
                        %let _OUTPUT1_label = %nrquote();
                        ...
                        /*---------------------------------------------------------------------
                         * NAME:       02_BNS_MOR_PD.sas
                         *
                         * PURPOSE:    Determines PD for BNS mortgages.
                         *             
                         * NOTES: 
                         *             
                         * MODIFIED:
                         *    10DEC2014 - JL - Created
                         *    15DEC2014 - WP - Changed the do loop in the last macro.  
                         *    14JAN2015 - JL - Updated code to run over all months instead of 
                         *                     just quarter end months. Changed qtr_end_dt to 
                         *                     mth_end_dt.
                         *
                        ...
                        /*-----------------------------------------------
                         * Used to select a list of observation periods 
                         * that defines the start of the observation 
                         * window. E.g., 31OCT2012 defines the start of 
                         * obs window from 31OCT2012 to 31OCT2013
                         *-----------------------------------------------*/
                        ...
                        /*Specifying a macro variable for the input data set.*/
                        %let _input_tbl = results.status_final_&pn.;
                        %let _interim_tbl1 = intmed.obs_window_&pn.;
                        %let _output_pd_tbl = results.twelve_mon_def_window_&pn.;
                        
                        
                        /*-----------------------------------------------
                         *  1. This defines the structure of the main table
                         *  that will be passed into the process to create
                         *  observation periods (reflects what is in NZ -
                         *  stacked history - i.e., multiple rows for each
                         *  mortgage, each row different process date):
                         *    - Mortage No
                         *    - Status
                         *    - Current Bal
                         *    - Process date
                        ...
                        proc sql noprint;
                           ...
                           select a.mortgage_no,
                                  a.status,
                                  a.current_bal,
                                  datepart(a.process_date) format = date9. as process_date
                           from &_input_tbl as a
                           order by a.mortgage_no, a.process_date;
                        quit;
                        
                        /*----------------------------------------------------
                         * 2. Defines the range of motnhs that act as the start
                        ...
                        /*-----------------------------------------------
                         * 3. The input table must contain these variables:
                         *    - Mortage No
                         *    - Status
                         *    - Current Bal
                         *    - Process date
                        ...
                        %macro create_pd_obs_window(_in_ds=, _out_ds=);
                           ...
                           data &_out_ds(rename = (mth_end_dt = process_date)
                                          drop = status 
                                                 process_date
                                                 current_bal
                                                 jj
                              ...
                              length mth_end_dt window_end_dt 8;
                               ...
                               *----------------------------------------*/
                              array _status(13) $3;
                              array _process_date(13);
                              array _current_bal(13);
                        
                              /*-------------------------------------------
                               * For each month end period needs separate
                               * array to hold intermediate values
                               *-------------------------------------------*/
                              %do aa = 1 %to &num_months;
                                 array _status_&aa(13) $3 _temporary_ ;
                                 array _process_date_&aa(13) _temporary_;
                                 array _current_bal_&aa(13) _temporary_;
                              %end;
                              ...
                              retain mortgage_no
                                     ...
                                     _status1 -- _status13
                                     _process_date1 -- _process_date13
                                     _current_bal1 -- _current_bal13
                              ...
                              format _process_date1 -- _process_date13 mth_end_dt window_end_dt date9.;
                              ...
                              %do mm = 1 %to &num_months;
                                  ...
                                  *------------------------------------------------------------*/
                                 if intnx('month', process_date, 0, 'e') GE "&&mth&mm"d and 
                                    intnx('month', process_date, 0, 'e') LE intnx('month', intnx('month', "&&mth&mm"d, 12, 'b'), 0, 'e') then
                                 do;
                                    
                                    counter&mm + 1;   
                        
                                    /* Used to determine which observation period is being created */
                                    if intnx('month', process_date, 0, 'e') EQ "&&mth&mm"d then mth_end_dt&mm = intnx('month', process_date, 0, 'e');
                        
                                    _status_&mm(counter&mm) = status;
                                    _process_date_&mm(counter&mm) = process_date;
                                    _current_bal_&mm(counter&mm) = current_bal;
                        
                                    /*------------------------------------------------------------
                                     * If last period of observation window OR there are no more
                                     * periods in data for mortgage, then output results
                                     *------------------------------------------------------------*/
                                    if counter&mm = 13 or last.mortgage_no = 1 then 
                                    do;
                                       do jj = 1 to 13;
                                          _status(jj) = _status_&mm(jj);
                                          _process_date(jj) = _process_date_&mm(jj);
                                          _current_bal(jj) = _current_bal_&mm(jj);
                                       end;
                        
                                       /* Sets the observation date - beginning of observation period */
                                       window_end_dt = intnx('month', intnx('month', "&&mth&mm"d, 12, 'b'), 0, 'e');
                        ...
                        /*----------------------------------------------------
                         * 4. Get Amort Value for the adjusted qtr and month    
                         *----------------------------------------------------*/
                        ...
                        %mend create_pd_obs_window;
                        %create_pd_obs_window(_in_ds = work.subset_data, 
                                              _out_ds = &_interim_tbl1)
                        
                        
                        /*----------------------------------------------------
                         * 5. Get Latest Default Month
                         *----------------------------------------------------*/
                        
                        
                        %macro last_new_default(_tbl_in=, _tbl_out=);
                        
                           data &_tbl_out (keep = mortgage_no
                                                  process_date
                                                  window_end_dt
                                                  _status1
                                                  default_date
                              ...
                              do;
                                 ...
                                 %do ii = 1 %to 12 %by 1;
                                    ...
                                    if _status&ii = "CUR" and _status&jj = "DEF"  then
                                    do; 
                                       default_ind = 1;
                        ...
                        %mend last_new_default;
                        %last_new_default(_tbl_in = &_interim_tbl1, 
                                          _tbl_out = &_output_pd_tbl)
                        /*---- End of User Written Code  ----*/ 
                        ...
                        /**  Step end MODEL_2_CODE_20150115 **/
                        
                        %let etls_endTime = %sysfunc(datetime(),datetime.);
                        
                        
                        
                        /**  Job end RRAP_MOR_MODEL_02_BNS_MOR_PD **/
         ...
         %mend etls_jobW2HPYXC; 
         
         %etls_jobW2HPYXC; 
         
      endrsubmit;
      
   %mend etls_processToLoopW2HPYX2;
   ...
   %let etls_controlName = L33_; 
   %let etls_statusTable = work.W1X1LWVF; 
   %let etls_parameterTable = work.W2HPYZR; 
   ...
   %let etls_controlTable = work.W1X1MZQ4;
   ...
   %do; 
      %do %until (&&&etls_controlName ge &&&etls_controlName._max); 
         ...
         %if &etls_processesRunning > 0 and &&&etls_signonMacVar ne 1 %then 
            %etls_processToLoopW2HPYX2(parameterTable=&etls_parameterTable, row=&&&etls_controlName,
...
/*==========================================================================* 
 * Step:            Loop End                              A57SWEI7.BK000Z5L * 
 * Transform:       Loop End                                                * 
 * Description:                                                             * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000Z5L);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
/*==========================================================================* 
 * Step:            Gather Partitions                     A57SWEI7.BK000Z5M * 
 * Transform:       User Written                                            * 
 * Description:                                                             * 
 *                                                                          * 
 * Source Table:    User Written - work.W1X1MZQ4          A57SWEI7.BN000NL5 * 
 * Target Table:    User Written - work.W3UGMT6           A57SWEI7.BN000NL7 * 
 *                                                                          * 
 * User Written:    SourceCode                                              * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000Z5M);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
%let _INPUT_count = 1;
%let _INPUT = work.W1X1MZQ4;
%let _INPUT_connect = ;
%let _INPUT_engine = ;
%let _INPUT_memtype = DATA;
%let _INPUT_options = %nrquote();
%let _INPUT_alter = %nrquote();
%let _INPUT_path = %nrquote(/User Written_A57SWEI7.BN000NL5%(WorkTable%));
%let _INPUT_type = 1;
%let _INPUT_label = %nrquote();

%let _INPUT1 = work.W1X1MZQ4;
%let _INPUT1_connect = ;
%let _INPUT1_engine = ;
%let _INPUT1_memtype = DATA;
%let _INPUT1_options = %nrquote();
%let _INPUT1_alter = %nrquote();
%let _INPUT1_path = %nrquote(/User Written_A57SWEI7.BN000NL5%(WorkTable%));
%let _INPUT1_type = 1;
%let _INPUT1_label = %nrquote();

%let _OUTPUT_count = 1;
%let _OUTPUT = work.W3UGMT6;
%let _OUTPUT_connect = ;
%let _OUTPUT_engine = ;
%let _OUTPUT_memtype = DATA;
%let _OUTPUT_options = %nrquote();
%let _OUTPUT_alter = %nrquote();
%let _OUTPUT_path = %nrquote(/User Written_A57SWEI7.BN000NL7%(WorkTable%));
%let _OUTPUT_type = 1;
%let _OUTPUT_label = %nrquote();
/* List of target columns to keep  */ 
%let _OUTPUT_keep = PN;
%let _OUTPUT_col_count = 1;
%let _OUTPUT_col0_name = PN;
%let _OUTPUT_col0_table = work.W3UGMT6;
%let _OUTPUT_col0_length = 8;
%let _OUTPUT_col0_type = $;
%let _OUTPUT_col0_format = ;
%let _OUTPUT_col0_informat = ;
...
%let _OUTPUT1 = work.W3UGMT6;
%let _OUTPUT1_connect = ;
%let _OUTPUT1_engine = ;
%let _OUTPUT1_memtype = DATA;
%let _OUTPUT1_options = %nrquote();
%let _OUTPUT1_alter = %nrquote();
%let _OUTPUT1_path = %nrquote(/User Written_A57SWEI7.BN000NL7%(WorkTable%));
%let _OUTPUT1_type = 1;
%let _OUTPUT1_label = %nrquote();
/* List of target columns to keep  */ 
%let _OUTPUT1_keep = PN;
%let _OUTPUT1_col_count = 1;
%let _OUTPUT1_col0_name = PN;
%let _OUTPUT1_col0_table = work.W3UGMT6;
%let _OUTPUT1_col0_length = 8;
%let _OUTPUT1_col0_type = $;
%let _OUTPUT1_col0_format = ;
%let _OUTPUT1_col0_informat = ;
...
data results.twelve_mon_def_window(rename=_status1=status1);
    set results.twelve_mon_def_window_0
		  results.twelve_mon_def_window_1
    	  results.twelve_mon_def_window_2
		  results.twelve_mon_def_window_3
		  results.twelve_mon_def_window_4
		  results.twelve_mon_def_window_5
		  results.twelve_mon_def_window_6
		  results.twelve_mon_def_window_7;	
run;

%delete_table(nzuser.twelve_mon_def_window);
   
data nzuser.twelve_mon_def_window (bulkload=yes BL_METHOD=CLILOAD);
     set results.twelve_mon_def_window;
run;
