   ...
   %macro etls_processToLoopW2ZT7E6(parameterTable=, row=, handleName=rmt);
      ...
      %macro etls_jobW2ZT7EG; 
		...
		%put &=sqlrc;
         ...
         proc append base=NZRRAP.BASEL_PSNL_LOAN_INSTRMNT_ADJ (BULKLOAD=YES BL_METHOD=CLILOAD)
          data=BASEL_PSNL_LOAN_INSTRMNT_ADJ force; run;

/*proc sql;
    select count(*) INTO: manul_error_check from NZRRAP.BASEL_PSNL_LOAN_INSTRMNT_ADJ WHERE MTH_TM_ID=&MTH_TM_ID.;
QUIT;
