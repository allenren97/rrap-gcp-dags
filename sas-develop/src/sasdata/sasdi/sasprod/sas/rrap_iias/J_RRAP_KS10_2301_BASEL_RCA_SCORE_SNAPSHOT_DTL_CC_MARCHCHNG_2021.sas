/**************************************************************************** 
 * Job:             J_RRAP_KS10_2301_BASEL_RCA_SCORE_SNA  A57SWEI7.BH0009HS * 
 *                  PSHOT_DTL_CC                                            * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                                                                          * 
 * Generated on:    Thursday, June 29, 2017 2:36:44 PM EDT                  * 
...
%let etls_jobName = %nrquote(J_RRAP_KS10_2301_BASEL_RCA_SCORE_SNAPSHOT_DTL_CC);
...
%macro etls_loopW2F6P5H; 
   ...
   %macro etls_processToLoopW2F6P5R(parameterTable=, row=, handleName=rmt);
      ...
      %macro etls_jobW2F6P61; 
         ...
         %etl_job_start(TARGET_TABLE=NETCON.BASEL_RCA_SCORE_DTL_SNAPSHOT,CONDITION=%nrbquote(BASEL_MODEL_ID IN (&MODEL_ID_DEL)) );
         /*---- End of Pre-Process Code  ----*/ 
         ...
         EXECUTE(DELETE FROM &net_db..BASEL_RCA_SCORE_DTL_SNAPSHOT WHERE MTH_TM_ID=&TIME_DIM_ID
		 ...
		 %if &syserr>0 then do %abort %abend 255;
		 ...
		 PROC APPEND BASE=NETCON.BASEL_RCA_SCORE_DTL_SNAPSHOT ( BULKLOAD=YES BL_METHOD=CLILOAD ) DATA=prg_data.CRITERIAS_DTL_CC FORCE; RUN;
