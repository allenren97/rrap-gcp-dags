...
line "TL Scorecard Distribution &file_name_date - SI above threshold";
endcomp;
run;
...
compute before _PAGE_;
line "TL Scorecard Distribution &file_name_date";
endcomp;
run;
proc report data=work.legend split='~' missing  noheader;
column BASEL_SCORECRD_NM;
...
SUBJECT= "[RRAP] SI above threshold for TL Scorecard Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&si_email_list);
     put;
...
%else %do;
FILENAME OUTMAIL EMAIL ATTACH=("&file_path.&file_name_tl")
SUBJECT= "[RRAP] TL Scorecard Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&email_list);
