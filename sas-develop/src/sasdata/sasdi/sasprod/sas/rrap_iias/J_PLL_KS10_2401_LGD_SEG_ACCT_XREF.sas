...
***************************************************************************************************************************;
***************************************************************************************************************************;
*  Job Name:J_PLL_KS10_2401_LGD_SEG_ACCT_XREF
*  Target Database: EDRTLRPLL
*  Target Table:  LGD_SEG_ACCT_XREF
*  
...
%let etls_jobName = %nrquote(J_PLL_KS10_2401_LGD_SEG_ACCT_XREF);
...
%macro etls_loopW2F5CJR; 
   ...
   %macro etls_processToLoopW2F5CK1(parameterTable=, row=, handleName=rmt);
      ...
      %macro etls_jobW2F5CKB; 
         ...
         /*==========================================================================* 
          * Step:            RRAP_DM_INS_LGD_SEG_ACCT_XREF         A57SWEI7.BK000YSM * 
          * Transform:       User Written                                            * 
          * Description:                                                             * 
          *                                                                          * 
         ...
         %etl_job_start(TARGET_TABLE=NETCON.LGD_SEG_ACCT_XREF);
         ...
         %DO i=1 %TO &total_query;
            ...
            CONNECT USING NETCON AS IIASCON;
               EXECUTE(
         			INSERT INTO EDRTLRPLL.LGD_SEG_ACCT_XREF (
         				 BASEL_ACCT_ID
         		       , MTH_TM_ID
         		       , BASEL_SEG_ID
         			   , BASEL_MODEL_REL_ID
         ...
         /**  Step end RRAP_DM_INS_LGD_SEG_ACCT_XREF **/
