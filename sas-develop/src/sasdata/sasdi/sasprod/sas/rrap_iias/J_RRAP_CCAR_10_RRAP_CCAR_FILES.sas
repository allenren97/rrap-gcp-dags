/**************************************************************************** 
 * Job:             J_RRAP_CCAR_10_RRAP_CCAR_FILES        A57ZQ4A4.BF0011JU * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                                                                          * 
 * Generated on:    Thursday, July 20, 2017 4:27:13 PM EDT                  * 
...
%let jobID = %quote(A57ZQ4A4.BF0011JU);
%let etls_jobName = %nrquote(J_RRAP_CCAR_10_RRAP_CCAR_FILES);
...
/*==========================================================================* 
 * Step:            CCAR_ECAP_AUTOEXEC                    A57ZQ4A4.BO0016DT * 
 * Transform:       CCAR_ECAP_AUTOEXEC                                      * 
 * Description:                                                             * 
 *==========================================================================*/ 

%let transformID = %quote(A57ZQ4A4.BO0016DT);
%let trans_rc = 0;
...
libname &LIB. "&DPATH.";
libname &DB. db2 database=&DB. schema =&dbschema. authdomain=db2_auth dbsliceparm=(all,10);
...
data &lib..BASEL_CCAR_EXPSR_EXTR;
...
format WGHTD_DLGD_RTO percent12.6;
...
nobs $6
hashtot $15;
file "&outlanding./cmf/outgoing/DR-AIRB-EXPOSURES-&WITHZERONET.&YYYYMMDD..ctl" ;**lrecl=203 
recfm=V ;
YYYYMMDD = "&YYYYMMDD.,";
rundt = "&rundt.,";
