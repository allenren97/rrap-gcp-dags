/**************************************************************************** 
 * Job:             J_RRAP_CCAR_02_RRAP_CCAR_EXPSR_FACT   A57ZQ4A4.BF0011JQ * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                                                                          * 
 * Generated on:    Thursday, July 20, 2017 4:27:18 PM EDT                  * 
...
%let jobID = %quote(A57ZQ4A4.BF0011JQ);
%let etls_jobName = %nrquote(J_RRAP_CCAR_02_RRAP_CCAR_EXPSR_FACT);
...
/*==========================================================================* 
 * Step:            CCAR_ECAP_AUTOEXEC                    A57ZQ4A4.BO0016DL * 
 * Transform:       CCAR_ECAP_AUTOEXEC                                      * 
 * Description:                                                             * 
 *==========================================================================*/ 

%let transformID = %quote(A57ZQ4A4.BO0016DL);
%let trans_rc = 0;
...
group by MTH_TM_ID,SRC_SYS_CD, CCAR_BASEL_PRD_TP_NM, PD_BAND,INSURER_FLAG, 
...
by 
MTH_TM_ID LEGAL_ENTITY CCAR_BASEL_PRD_TP_NM PD_BAND LGD_BASEL_SEG_NUM EAD_BASEL_SEG_NUM INSUR_F; 
quit;
...
proc sql noprint;
	create table INPATH._temp_aggr_ACL as
		select  MTH_TM_ID,
			...
			sum(PRORATED_CR_LOSS_ALLOW_AMT_AFTER) as After_Netting_ACL 
		from INPATH._temp_acct_prorated_loss
			group by MTH_TM_ID,SRC_SYS_CD, CCAR_BASEL_PRD_TP_NM, PD_BAND,INSURER_FLAG, WGHTD_DLGD_RTO,
				PD_BASEL_SEG_NUM, EAD_BASEL_SEG_NUM, LGD_BASEL_SEG_NUM
			order by MTH_TM_ID, SRC_SYS_CD, CCAR_BASEL_PRD_TP_NM, PD_BAND, 
				PD_BASEL_SEG_NUM, EAD_BASEL_SEG_NUM, LGD_BASEL_SEG_NUM
	;
...
proc sort data= &INPATH..RRAP_Rpt_Extract_AllBank nodupkey; 
by 
MTH_TM_ID LEGAL_ENTITY CCAR_BASEL_PRD_TP_NM PD_BAND LGD_BASEL_SEG_NUM EAD_BASEL_SEG_NUM INSUR_F WGHTD_DLGD_RTO; 
quit;
