/* This is a copy of RRAP_SPL_UPDATE_DPD.sas file, but only difference is this code connects to EDL Server 290*/
...
libname covid19 hadoop server="sdpsvrwm0290.scglobal.ad.scotiacapital.com" schema=crz_covid19_ca DBMAX_TEXT=300 
authdomain="EDL_Auth" 
uri="jdbc:hive2://sdpsvrwm0290.scglobal.ad.scotiacapital.com:8443/crz_covid19_ca;ssl=true;sslTrustStore=/sashome/hadoop/gateway.jks;trustStorePassword=Test123?hive.server2.transport.mode=http;hive.server2.thrift.http.path=gateway/default/hive"
login_timeout=0;
