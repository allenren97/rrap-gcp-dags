/**************************************************************************** 
 * Job:             J_RRAP_TL10_2402_BASEL_PNL_LN_LGDD_S  A57SWEI7.BH0009IR * 
 *                  EG_MTH_RLZ_VAL                                          * 
 ...
 *                  _VAL                                                    * 
 *                                                                          * 
 * Generated on:    Thursday, June 29, 2017 2:40:04 PM EDT                  * 
...
%let jobID = %quote(A57SWEI7.BH0009IR);
%let etls_jobName = %nrquote(J_RRAP_TL10_2402_BASEL_PNL_LN_LGDD_SEG_MTH_RLZ_VAL);
...
/*==========================================================================* 
 * Step:            Get_run_dates_for_LGD                 A57SWEI7.BK000YY1 * 
 * Transform:       Extract                                                 * 
 * Description:                                                             * 
 *                                                                          * 
 * Source Table:    TM_DIM - NZRRAP.TM_DIM                A57SWEI7.BE000412 * 
 * Target Table:    Extract - work.TIME_KEY               A57SWEI7.BN000NIL * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000YY1);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
proc sql;
   create table work.TIME_KEY as
      select
         TM_ID,
         TM_LVL_END_DT,
         (TM_ID-960) as PRIOR24MONTHS length = 8
            format = 11.
            informat = 11.
            label = 'PRIOR24MONTHS'
   from &SYSLAST
...
/**  Step end Get_run_dates_for_LGD **/

/*==========================================================================* 
 * Step:            Loop                                  A57SWEI7.BK000YY2 * 
 * Transform:       Loop                                                    * 
 * Description:                                                             * 
 *                                                                          * 
 * Source Table:    Extract - work.TIME_KEY               A57SWEI7.BN000NIL * 
 * Target Table:    Loop - work.WE98GJI                   A57SWEI7.BN000NIM * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000YY2);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
%macro etls_loopW2GDCO1; 
   %local etls_filePrefix; 
   %let etls_filePrefix = ; 
   
   %macro etls_processToLoopW2GDCOB(parameterTable=, row=, handleName=rmt);
      %local etls_parmvars; 
      ...
      %macro etls_jobW2GDCOL; 
      
         /*==========================================================================* 
          * Step:            Delete                                A57SWEI7.BK000YY3 * 
          * Transform:       Delete                                                  * 
          * Description:                                                             * 
          *                                                                          * 
          * Source Tables:   Loop - work.WE98GJI                   A57SWEI7.BN000NIM * 
          *                  BASEL_SEG - NZRRAP.BASEL_SEG          A57SWEI7.BE00041L * 
         ...
         %let transformID = %quote(A57SWEI7.BK000YY3);
         %let trans_rc = 0;
         %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
         ...
         PROC SQL NOPRINT;
         SELECT DISTINCT BASEL_SEG_ID INTO :SEG_IDS SEPARATED BY ',' FROM NZRRAP.BASEL_SEG WHERE BASEL_SEG_NM LIKE '%LGD-D%';
         QUIT;
            ...
            proc sql;
               ...
               where
                  BASEL_PNL_LN_LGD_SEG_MTH_RLZ_VAL.BASEL_SEG_ID IN (
                     ...
                     where
                        BASEL_SEG_TO_DEL.BASEL_SEG_NM LIKE '%LGD-D%'
                  )
         ...
         /*==========================================================================* 
          * Step:            Inner Join_for_LGD                    A57SWEI7.BK000YY4 * 
          * Transform:       Join                                                    * 
          * Description:                                                             * 
          *                                                                          * 
          * Source Tables:   BASEL_PNL_LN_LGD_SEG_ACCT_XREF -      A57SWEI7.BE000440 * 
          ...
          *                  PSNL_LN_LGD_OBSVT_PT_RELZ_VAL -       A57SWEI7.BE000449 * 
          *                   NZRRAP.PSNL_LN_LGD_OBSVT_PT_RELZ_VAL                   * 
          * Target Table:    Join - work.WE1Q3O7                   A57SWEI7.BN000NIN * 
          *==========================================================================*/ 
         
         %let transformID = %quote(A57SWEI7.BK000YY4);
         %let trans_rc = 0;
         %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
         ...
         proc sql;
            ...
            where
               ...
               and PSNL_LN_LGD_OBSVT_PT_RELZ_VAL.LGD_TYPE = 'LGD-D'
               and BASEL_PNL_LN_LGD_SEG_ACCT_XREF.MTH_TM_ID = &PRIOR24MONTHS
               and PSNL_LN_LGD_OBSVT_PT_RELZ_VAL.OBSVTN_MTH_TM_ID = &PRIOR24MONTHS
            group by
               BASEL_SEG_ID,
               MTH_TM_ID,
               BASEL_MODEL_REL_ID,
         ...
         /*==========================================================================* 
          * Step:            Lookup                                A57SWEI7.BK000YY6 * 
          * Transform:       Lookup                                                  * 
          * Description:                                                             * 
          *                                                                          * 
          * Source Tables:   Join - work.WE1Q3O7                   A57SWEI7.BN000NIN * 
          *                  BASEL_SEG - NZRRAP.BASEL_SEG          A57SWEI7.BE00041L * 
          *                  BASEL_SEG_RPTG_PARM -                 A57SWEI7.BE00041M * 
          *                   NZRRAP.BASEL_SEG_RPTG_PARM                             * 
          * Target Table:    Lookup - work.PRELOAD                 A57SWEI7.BN000NIO * 
          *==========================================================================*/ 
         
         %let transformID = %quote(A57SWEI7.BK000YY6);
         %let trans_rc = 0;
         %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
         ...
         DATA  work.PRELOAD
                  (keep = BASEL_SEG_ID MTH_TM_ID BASEL_MODEL_REL_ID BASEL_MODEL_ID 
                          OBSVTN_MTH_TM_ID TOT_ACCT_CNT LGD_ACCT_TOT_RTO SEG_NUM BASEL_SEG_NM 
                          FINAL_RTO )
               ; 
         ...
         /*==========================================================================* 
          * Step:            Table Loader                          A57SWEI7.BK000YY7 * 
          * Transform:       Table Loader (Version 2.1)                              * 
          * Description:                                                             * 
          *                                                                          * 
          * Source Table:    Lookup - work.PRELOAD                 A57SWEI7.BN000NIO * 
          * Target Table:    BASEL_PNL_LN_LGD_SEG_MTH_RLZ_VAL -    A57SWEI7.BE000441 * 
          *                  NZRRAP.BASEL_PNL_LN_LGD_SEG_MTH_RLZ                     * 
          *                  _VAL                                                    * 
          *==========================================================================*/ 
         
         %let transformID = %quote(A57SWEI7.BK000YY7);
         %let trans_rc = 0;
         %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
               ...
               create view work.W2GDCQ8 as
                  select
                     ...
                     TOT_ACCT_CNT   
                        format = 11.
                        informat = 11.,
                     (CASE WHEN SEG_NUM IN (6,7,8) THEN 1.06 ELSE LGD_ACCT_TOT_RTO  / TOT_ACCT_CNT END) as LGD_SEG_RTO length = 8
                        format = 17.8
                        informat = 17.8,
   ...
   %mend etls_processToLoopW2GDCOB;
   ...
   %let etls_parameterTable = work.W2GDCQL; 
   ...
   data &etls_statusTable 
      (keep = etls_handleName etls_machineId etls_startTime etls_endTime etls_status 
              etls_jobRC TM_ID TM_LVL_END_DT PRIOR24MONTHS
      );
   ...
   proc sql; 
      create table &etls_parameterTable as 
         select PRIOR24MONTHS as PRIOR24MONTHS, 
                TM_ID as MTH_TM_ID, 
   ...
   %do; 
      %do %until (&&&etls_controlName ge &&&etls_controlName._max); 
         ...
         %etls_processToLoopW2GDCOB(parameterTable=&etls_parameterTable, row=&&&etls_controlName,
...
/*==========================================================================* 
 * Step:            Loop End                              A57SWEI7.BK000YY8 * 
 * Transform:       Loop End                                                * 
 * Description:                                                             * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000YY8);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
