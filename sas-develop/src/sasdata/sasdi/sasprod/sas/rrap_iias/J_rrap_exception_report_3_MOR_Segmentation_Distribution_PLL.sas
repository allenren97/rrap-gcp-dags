...
%let file_name_mor =BNS_PLL Segmentation_Distribution_&file_name_date..xls;
...
line "BNS Segmentation Distribution &file_name_date - SI above threshold";
endcomp;
run;
...
compute before _PAGE_;
line "BNS Segmentation Distribution &file_name_date";
endcomp;
run;
proc report data=work.legend split='~' missing  noheader
;
...
SUBJECT= "[RRAP] SI above threshold for BNS Parallel Segmentation Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&si_email_list);
     put;
...
%else %do;
FILENAME OUTMAIL EMAIL ATTACH=("&file_path.&file_name_mor")
SUBJECT= "[RRAP] BNS Parallel Segmentation Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&email_list);
