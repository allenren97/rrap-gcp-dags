/**************************************************************************** 
 * Job:             J_RRAP_KS10_2401_LGD_SEG_ACCT_XREF    A57SWEI7.BH0009HZ * 
 * Description:                                                             * 
 *                                                                          * 
...
%let etls_jobName = %nrquote(J_RRAP_KS10_2401_LGD_SEG_ACCT_XREF);
      ...
      %macro etls_jobW2F5CKB; 
         ...
         /*	BELOW QUERY CHANGED DUE TO REQUIREMENT AS PART OF Q4 PHASE - SEP162015*/
         	...
         	Proc sql;
               ...
               EXECUTE(
         			INSERT INTO EDRTLRP1D.LGD_SEG_ACCT_XREF (
         				 BASEL_ACCT_ID
         		       , MTH_TM_ID
         		       , BASEL_SEG_ID
         			   , BASEL_MODEL_REL_ID
