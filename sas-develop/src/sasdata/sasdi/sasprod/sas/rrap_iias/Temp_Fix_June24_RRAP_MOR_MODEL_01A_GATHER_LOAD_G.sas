/**************************************************************************** 
 * Job:             RRAP_MOR_MODEL_01A_GATHER_LOAD_G      A57SWEI7.BH0009JY * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                   control.CNTL_PARTITIONS                                * 
 *                                                                          * 
 * Generated on:    Thursday, June 29, 2017 2:43:43 PM EDT                  * 
...
%let jobID = %quote(A57SWEI7.BH0009JY);
%let etls_jobName = %nrquote(RRAP_MOR_MODEL_01A_GATHER_LOAD_G);
...
/*==========================================================================* 
 * Step:            Loop                                  A57SWEI7.BK000Z5D * 
 * Transform:       Loop                                                    * 
 * Description:                                                             * 
 *                                                                          * 
 * Source Table:    CNTL_PARTITIONS -                     A57SWEI7.BE00044L * 
 *                   control.CNTL_PARTITIONS                                * 
 * Target Table:    Loop - work.W8FEPO                    A57SWEI7.BN000NL3 * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000Z5D);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
%macro etls_loopW2HOIEO; 
   %local etls_filePrefix; 
   %let etls_filePrefix = ; 
   
   %macro etls_processToLoopW2HOIEY(parameterTable=, row=, handleName=rmt);
      ...
      rsubmit &handleName wait = no sysrputsync = yes persist = no; 
         ...
         %macro etls_jobW2HOIF8; 
            ...
            /* Setup to capture return codes  */ 
                        ...
                        %mend rcSetDS; 
                        /**************************************************************************** 
                         * Job:             RRAP_MOR_MODEL_01A_GATHER_LOAD        A57SWEI7.BH0009J7 * 
                         * Description:                                                             * 
                         *                                                                          * 
                         * Metadata Server: 10.56.70.48                                             * 
                         * Port:            8561                                                    * 
                         ...
                         * Server:          SASApp                                A57SWEI7.AT000002 * 
                         *                                                                          * 
                         * Generated on:    Thursday, June 29, 2017 2:43:44 PM EDT                  * 
                         * Generated by:    owprdsas                                                * 
                         * Version:         SAS Data Integration Studio 4.8                         * 
                         ****************************************************************************/ 
                        ...
                        /* General macro variables  */ 
                        %let jobID = %quote(A57SWEI7.BH0009J7);
                        %let etls_jobName = %nrquote(RRAP_MOR_MODEL_01A_GATHER_LOAD);
                        %let etls_userID = %nrquote(owprdsas);
                        ...
                        /*==========================================================================* 
                         * Step:            AM_rrap_mortgage_autoexec             A57SWEI7.BK000Z3F * 
                         * Transform:       AM_rrap_mor_bns_autoexec                                * 
                         * Description:     BNS Mortgage jobs imported from IW503 leverage this     * 
                         *                   transformation                                         * 
                         *==========================================================================*/ 
                        
                        %let transformID = %quote(A57SWEI7.BK000Z3F);
                        %let trans_rc = 0;
                        %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
                        ...
                        /*==========================================================================* 
                         * Step:            User Written                          A57SWEI7.BK000Z3G * 
                         * Transform:       User Written                                            * 
                         * Description:                                                             * 
                         *                                                                          * 
                         * Target Table:    User Written - work.W91R4O2           A57SWEI7.BN000NPW * 
                         *                                                                          * 
                         * User Written:    SourceCode                                              * 
                         *==========================================================================*/ 
                        
                        %let transformID = %quote(A57SWEI7.BK000Z3G);
                        %let trans_rc = 0;
                        %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
                        
                        %let _INPUT_count = 0;
                        %let _OUTPUT_count = 1;
                        %let _OUTPUT = work.W91R4O2;
                        %let _OUTPUT_connect = ;
                        %let _OUTPUT_engine = ;
                        %let _OUTPUT_memtype = DATA;
                        %let _OUTPUT_options = %nrquote();
                        %let _OUTPUT_alter = %nrquote();
                        %let _OUTPUT_path = %nrquote(/User Written_A57SWEI7.BN000NPW%(WorkTable%));
                        %let _OUTPUT_type = 1;
                        %let _OUTPUT_label = %nrquote();
                        %let _OUTPUT_col_count = 0;
                        
                        %let _OUTPUT1 = work.W91R4O2;
                        %let _OUTPUT1_connect = ;
                        %let _OUTPUT1_engine = ;
                        %let _OUTPUT1_memtype = DATA;
                        %let _OUTPUT1_options = %nrquote();
                        %let _OUTPUT1_alter = %nrquote();
                        %let _OUTPUT1_path = %nrquote(/User Written_A57SWEI7.BN000NPW%(WorkTable%));
                        %let _OUTPUT1_type = 1;
                        ...
                        /*----------------------------------------------------
                         * 1. Load Partition Table from MODEL_01    
                         *----------------------------------------------------*/
                        %delete_table(&target_lib..status_final_&pn.);
                        
                        /*proc sql;*/
                        /*    create table &target_lib..status_final_&pn. (bulkload=yes) as			 */
                        /*    select * from */
                        /*	 results.status_final_&pn. as a*/
                        /*	 where intnx('month', datepart(a.process_date), 0, 'e') >=  "31JAN2010"d;     * This Date needs to be set outside the Job or removed entirely ; 		*/
                        /*quit;		*/
				...
				/* Sudhir
                        proc sql;
                            create table &target_lib..status_final_&pn. (bulkload=yes BL_METHOD=CLILOAD) as			 
                            select * from 
                        	 results.status_final_&pn. 
                        		where 0=1;	
                        quit;	*/


						data &target_lib..status_final_&pn. (bulkload=yes BL_METHOD=CLILOAD);
						    set results.status_final_&pn.(where=(intnx('month', datepart(process_date), 0, 'e') >=  "31JAN2010"d));
						run;

         
                        /* Sudhir -->
                        
                        proc append base=&target_lib..status_final_&pn. (bulkload=yes BL_METHOD=CLILOAD)
                        		data=results.status_final_&pn.(where=(intnx('month', datepart(process_date), 0, 'e') >=  "31JAN2010"d)) force; run; 
						*/
                        ...
                        /**  Job end RRAP_MOR_MODEL_01A_GATHER_LOAD **/
         ...
         %mend etls_jobW2HOIF8; 
         
         %etls_jobW2HOIF8; 
         
      endrsubmit;
      
   %mend etls_processToLoopW2HOIEY;
   ...
   %let etls_controlName = L51_; 
   %let etls_statusTable = work.W8FEPO; 
   %let etls_parameterTable = work.W2HOIHM; 
   ...
   %do; 
      %do %until (&&&etls_controlName ge &&&etls_controlName._max); 
         ...
         %if &etls_processesRunning > 0 and &&&etls_signonMacVar ne 1 %then 
            %etls_processToLoopW2HOIEY(parameterTable=&etls_parameterTable, row=&&&etls_controlName,
...
/*==========================================================================* 
 * Step:            Loop End                              A57SWEI7.BK000Z5F * 
 * Transform:       Loop End                                                * 
 * Description:                                                             * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000Z5F);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
/*==========================================================================* 
 * Step:            User Written                          A57SWEI7.BK000Z5G * 
 * Transform:       User Written                                            * 
 * Description:                                                             * 
 *                                                                          * 
 * Source Table:    CNTL_PARTITIONS -                     A57SWEI7.BE00044L * 
 *                   control.CNTL_PARTITIONS                                * 
 * Target Table:    User Written - work.WAOIPK            A57SWEI7.BN000NL4 * 
 *                                                                          * 
 * User Written:    SourceCode                                              * 
 *==========================================================================*/ 

%let transformID = %quote(A57SWEI7.BK000Z5G);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
%let _OUTPUT_count = 1;
%let _OUTPUT = work.WAOIPK;
%let _OUTPUT_connect = ;
%let _OUTPUT_engine = ;
%let _OUTPUT_memtype = DATA;
%let _OUTPUT_options = %nrquote();
%let _OUTPUT_alter = %nrquote();
%let _OUTPUT_path = %nrquote(/User Written_A57SWEI7.BN000NL4%(WorkTable%));
%let _OUTPUT_type = 1;
%let _OUTPUT_label = %nrquote();
...
%let _OUTPUT_col0_table = work.WAOIPK;
...
%let _OUTPUT_col1_table = work.WAOIPK;
...
%let _OUTPUT_col2_table = work.WAOIPK;
...
%let _OUTPUT1 = work.WAOIPK;
%let _OUTPUT1_connect = ;
%let _OUTPUT1_engine = ;
%let _OUTPUT1_memtype = DATA;
%let _OUTPUT1_options = %nrquote();
%let _OUTPUT1_alter = %nrquote();
%let _OUTPUT1_path = %nrquote(/User Written_A57SWEI7.BN000NL4%(WorkTable%));
%let _OUTPUT1_type = 1;
%let _OUTPUT1_label = %nrquote();
/* List of target columns to keep  */ 
...
%let _OUTPUT1_col0_table = work.WAOIPK;
...
%let _OUTPUT1_col1_table = work.WAOIPK;
...
%let _OUTPUT1_col2_table = work.WAOIPK;
...
proc sql /*noprint*/;
   ...
   execute (drop table &target_lib3..status_final if exists) by nzcon;
   execute (
       create table &target_lib3..status_final as (
       select a.*
       from &target_lib3..status_final_0 as a ) WITH DATA
   ) by nzcon;

/*Sudhir -->

   execute (
       insert into &target_lib3..status_final 
       select a.*
       from &target_lib3..status_final_1 as a
   ) by nzcon;
   execute (
       insert into &target_lib3..status_final 
       select a.*
       from &target_lib3..status_final_2 as a
   ) by nzcon;    
	execute (
       insert into &target_lib3..status_final  
       select a.*
       from &target_lib3..status_final_3 as a
   ) by nzcon;
	execute (
       insert into &target_lib3..status_final  
       select a.*
       from &target_lib3..status_final_4 as a
   ) by nzcon;
	execute (
       insert into &target_lib3..status_final  
       select a.*
       from &target_lib3..status_final_5 as a
   ) by nzcon;
	execute (
       insert into &target_lib3..status_final  
       select a.*
       from &target_lib3..status_final_6 as a
   ) by nzcon;
	execute (
       insert into &target_lib3..status_final  
       select a.*
       from &target_lib3..status_final_7 as a
   ) by nzcon; */

disconnect from nzcon;
quit;

%macro Load_Status_FINAl;
%do i = 1 %to 7;
proc sql;
  	insert into &target_lib..status_final (bulkload=yes BL_METHOD=CLILOAD)
    select *
      from NZUSER.status_final_&i ;
quit;
%end;
%mend Load_Status_FINAl;
%Load_Status_FINAl;
