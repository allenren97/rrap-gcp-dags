...
proc sql;
   ...
   select distinct t1.mort_num, 
      ...
      where t1.mth_end_dt >= '29feb2020'd and t1.mth_end_dt >= calculated mth_end_prior_req_def_date
      and intck('month',calculated mth_end_prior_req_def_date,t1.mth_end_dt) <=1
