/**************************************************************************** 
 * Job:             J_RRAP_CCAR_04_RRAP_RPTG_RVL_CR_SCRD  A57ZQ4A4.BF0011K0 * 
 *                  _OTH_MORT_FACT                                          * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                                                                          * 
 * Generated on:    Thursday, July 20, 2017 4:27:15 PM EDT                  * 
...
%let jobID = %quote(A57ZQ4A4.BF0011K0);
%let etls_jobName = %nrquote(J_RRAP_CCAR_04_RRAP_RPTG_RVL_CR_SCRD_OTH_MORT_FACT);
...
/*==========================================================================* 
 * Step:            CCAR_ECAP_AUTOEXEC                    A57ZQ4A4.BO0016DN * 
 * Transform:       CCAR_ECAP_AUTOEXEC                                      * 
 * Description:                                                             * 
 *==========================================================================*/ 

%let transformID = %quote(A57ZQ4A4.BO0016DN);
%let trans_rc = 0;
...
/**************************************************************************** 
 * Job:             RRAP_STG_INS_RPTG_RVL_CR_SCRD_OTH_MORT_FACT.sas         * 
 *                                                                          * 
 * Description:                                                             * 
 *                                                                          * 
 * Metadata Server: cs2iw503.bns                                            * 
 ...
 *                  LDD.BASEL_ANALYTCL_BL_INSTRMNT_F                     * 
 *                  ACT                                                     * 
 *                  BASEL_REVLVNG_CR_RPTG_DRVD_VAR -      A57ZQ4A4.BI000026 * 
 *                  LDD.BASEL_REVLVNG_CR_RPTG_DRVD_V                     * 
 *                  AR                                                      * 
 *                  BASEL_SCRTY_TP_LKP -                  A57ZQ4A4.BI00002J * 
 *                   LDD.BASEL_SCRTY_TP_LKP                              * 
 * Target Table:    BASEL_RPTG_REVL_CR_SCRD_OT_MORT -     A57ZQ4A4.BI00002G * 
 *                  LDD.BASEL_RPTG_REVL_CR_SCRD_OT_M                     * 
 *                  ORT                                                     * 
 *                                                                          * 
 * Generated on:    Tuesday, September 16, 2014 8:43:57 AM EDT              * 
 * Generated by:    khmood                                                  * 
 * Version:         SAS Data Integration Studio 4.8                         * 
 ****************************************************************************/ 
%rrap_autoexec(RRAPENV=REVOLVING_CREDIT);
...
proc append base = EDRRAPT.BASEL_RPTG_REVL_CR_SCRD_OT_MORT 
     data = work._temp_revl_cr_ot_mort force ; 
run; 

proc sql;
connect to db2 as db1con(database=&dbname authdomain=db2_auth);
execute(
