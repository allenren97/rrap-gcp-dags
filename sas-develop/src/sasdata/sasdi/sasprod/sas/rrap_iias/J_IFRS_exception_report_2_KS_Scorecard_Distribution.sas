...
%let file_name_tl=IFRS9_PLL_TL_Scorecard_Distribution_&file_name_date..xls;
%let file_name_ks=IFRS9_PLL_KS_Scorecard_Distribution_&file_name_date..xls;
%let file_name_mor=IFRS9_PLL_BNS_TNG_MOR_Scorecard_Distribution_&file_name_date..xls;
%put &file_name_tl;
%put &file_name_ks;
%put &file_name_mor;
...
SUBJECT= "IFRS9 Parallel SC: SI above threshold for reports - &file_name_ks"
/* FROM= "RMSS" */;
DATA _NULL_;
     FILE OUTMAIL
     TO= (&si_email_list);
...
%else %do;
FILENAME OUTMAIL EMAIL ATTACH=("&file_path.&file_name_ks")
SUBJECT= "IFRS9 Parallel SC: Reports - &file_name_ks"
/* FROM= "RMSS" */;
DATA _NULL_;
     FILE OUTMAIL
     TO= (&email_list);
...
%PUT IFRS9 Parallel SC: RRAP Exception report 2 KS - Start Time: %Sysfunc(PutN(&datetime_start.,datetime18.));
