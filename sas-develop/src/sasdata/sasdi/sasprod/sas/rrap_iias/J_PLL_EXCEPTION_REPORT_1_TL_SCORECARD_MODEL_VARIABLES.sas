...
%let file_name=TL_PLL_Scorecard_Model_Variables_&file_name_date..xls;
%put &file_name;
		...
		%do;
			...
			;
				...
				compute before _PAGE_;
					line "TL Parallel Run Scorecard Model Variables &file_name_date - SI above threshold";
				endcomp;
			run;
	...
	%else
		%do;
			...
			;
				...
				compute before _PAGE_;
					line "TL Parallel Run Scorecard Model Variables &file_name_date";
				endcomp;
			run;
...
%macro sendemail;
	%if &email_alert = 1 %then
		%do;
			...
			FILENAME OUTMAIL EMAIL ATTACH="&file_path.&file_name"
				SUBJECT= "[RRAP] SI above threshold for TL Parallel Run Scorecard Model Variables Report - &MonthYear.";
	...
	%else
		%do;
			...
			FILENAME OUTMAIL EMAIL ATTACH="&file_path.&file_name"
				SUBJECT= "[RRAP] TL Parallel Run Scorecard Model Variables Report - &MonthYear.";
