...
line "TL Segmentation Distribution &file_name_date - SI above threshold";
endcomp;
run;
...
endcomp;
compute before _PAGE_;
line "TL Segmentation Distribution &file_name_date";
endcomp;
run;
proc report data=work.legend split='~' missing  noheader
;
...
SUBJECT= "[RRAP] SI above threshold for TL Segmentation Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&si_email_list);
     put;
...
%else %do;
FILENAME OUTMAIL EMAIL ATTACH=("&file_path.&file_name_tl")
SUBJECT= "[RRAP] TL Segmentation Distribution Report - &MonthYear.";
DATA _NULL_;
     FILE OUTMAIL
     TO= (&email_list);
