...
LIBNAME DB2RRAP  DB2  DATABASE="&RRAP_DB2"  SCHEMA=EDRRAPT user="&db2user" pwd="&db2password" readbuff=10000;
LIBNAME Owstar DB2  Datasrc="&DB2PASSTHRU"  SCHEMA=OWSTAR  user="s5197480" pwd="{SAS002}D5637855096E87730938B12F2E22D60C1606846E" access=readonly readbuff=10000;

LIBNAME nzuser  DB2 DATABASE="&IIASDB"  SCHEMA="&FRG_DB" user="&iiasuser" pwd="&iiaspassword" readbuff=10000 INSERTBUFF=10000;
LIBNAME nzintmed  DB2 DATABASE="&IIASDB" SCHEMA="&FRG_DB" user="&iiasuser" pwd="&iiaspassword" readbuff=10000 INSERTBUFF=10000;
LIBNAME NZRRAP  DB2 DATABASE="&IIASDB" SCHEMA="&RRAP_DB" user="&iiasuser" pwd="&iiaspassword" readbuff=10000 INSERTBUFF=10000;
LIBNAME NZFRG  DB2 DATABASE="&IIASDB" SCHEMA="&FRG_USR" user="&iiasuser" pwd="&iiaspassword" readbuff=10000 INSERTBUFF=10000;
...
LIBNAME NZUSER     DB2 DATABASE="&IIASDB" SCHEMA="&frg_usr" user="&iiasuser" pwd="&iiaspassword" readbuff=10000 INSERTBUFF=10000;
LIBNAME NZRRAP     DB2 DATABASE="&IIASDB" SCHEMA="&EDRTLRP1D" user="&iiasuser" pwd="&iiaspassword";
LIBNAME NZWRK     DB2 DATABASE="&IIASDB" SCHEMA="&EDRTLRFRGP1D" user="&iiasuser" pwd="&iiaspassword";


/* DB2 Lib */
LIBNAME Owstar DB2  Datasrc="&DB2PASSTHRU"  SCHEMA=OWSTAR  user="&db2user" pwd="&db2password" ACCESS=READONLY readbuff=10000;
LIBNAME CB DB2  Datasrc="&DB2PASSTHRU"  SCHEMA=CB  user="&db2user" pwd="&db2password" ACCESS=READONLY readbuff=10000;
LIBNAME SAS DB2  Datasrc="&DB2PASSTHRU"  SCHEMA=FRG  user="&db2user" pwd="&db2password" readbuff=300 ACCESS=READONLY;
libname owdss db2 datasrc="&DB2PASSTHRU" schema=owdss  user="&db2user" pwd="&db2password" ACCESS=READONLY readbuff=10000;
LIBNAME EDRTLR DB2 DATASRC="&DBNAME" SCHEMA=EDRTLR  user="&db2user2" pwd="&db2password2"; /*genl_lkp uses this*** Dev */ 
LIBNAME OWTACT DB2 DATASRC="&DB2PASSTHRU" SCHEMA=OWTACT user="&db2user" pwd="&db2password" ACCESS=READONLY readbuff=10000; 
...
*/
libname NZUSER netezza server=cs2iwntzp01 database=frg_user_data user="s4126431" pwd="{SAS002}F588B3150B248D24078E3F8211E3D94E1DAAB71E";
libname NZUSERIC netezza server=cs2iwntzp01 database=frg_user_data_IC user="s4126431" pwd="{SAS002}F588B3150B248D24078E3F8211E3D94E1DAAB71E";
