...
/* options metaport       = &metaPort   -- copied from prod, please check for IIAS
...
%macro rrap_dlgd_autoexec();
    ...
    libname EDRRAPT db2 datasrc=DM1U1D schema=EDRRAPT authdomain=db2u_auth readbuff=10000 INSERTBUFF=10000;
...
%macro rrap_ncrbtt_autoexec();
		...
		%end;
			...
			libname db2_org db2 database=DM1U1D schema=EDEDW   authdomain=DB2U_AUTH access=readonly;
			libname db2_prd db2 database=DM1U1D SCHEMA=EDRRAPT authdomain=DB2U_AUTH access=readonly;

		%let DBNAME=DM1U1D; %let DBSCHEMA=EDRRAPBTT;
/*		%let DBNAME=DM1U5D; %let DBSCHEMA=EDRRAPBTT;*/

			*LIBNAME BTT DB2 DATABASE="&DBNAME" SCHEMA="&DBSCHEMA" user="&db2user" pwd="&db2password";
			LIBNAME BTT DB2 database="&DBNAME" schema="&DBSCHEMA" authdomain=DB2U_AUTH;
...
LIBNAME DB2RRAP DB2 DATABASE=&RRAP_DB2 SCHEMA=EDRRAPT authdomain=DB2U_AUTH;
...
/* DB2 */
libname db2_org db2 database=DM1U1D schema=EDEDW authdomain=DB2U_AUTH;
libname db2_all db2 database=DM1U1D schema=EDRRAP authdomain=DB2U_AUTH;
libname db2_tmdm db2 database=DM1U1D schema=EDEDWT authdomain=DB2U_AUTH;/*instrument fact uses this, revert this before promotion*/
LIBNAME DB2RRAP DB2  Datasrc=DM1U1D  SCHEMA=EDRRAPT authdomain=DB2U_AUTH;
...
LIBNAME EDRTLR DB2 DATASRC=DM1U1D SCHEMA=EDRTLR authdomain=DB2U_AUTH; /*genl_lkp uses this*/
LIBNAME DB2RRAP db2 datasrc=DM1U1D Schema=EDRRAPT authdomain=DB2U_AUTH;
...
LIBNAME LDD	DB2 Database=&db schema=EDRRAPT authdomain=DB2U_AUTH;
LIBNAME DB2RRAP DB2 DATABASE="&DBNAME" SCHEMA="&DBSCHEMA" authdomain=DB2U_AUTH;
LIBNAME DDB2CON DB2 DATABASE="&DBNAME" SCHEMA="&DBSCHEMA" authdomain=DB2U_AUTH;
LIBNAME &DB.    DB2 DATABASE="&DBNAME" SCHEMA="&DBSCHEMA" authdomain=DB2U_AUTH;
LIBNAME EDRRAPT DB2 DATABASE="&DBNAME" SCHEMA="&DBSCHEMA" authdomain=DB2U_AUTH;
LIBNAME EDRTLRT DB2 DATABASE="&DBNAME" SCHEMA="&DBSCHEMA1" authdomain=DB2U_AUTH;
...
%LET ACAPRPT=&rrap_dir./flat_files/rrap_iias/acap;
...
/* for report 1 SPL, KS /*  
LIBNAME NZRRAP DB2 DATABASE="&IIASDB" SCHEMA="&EDRTLRP1D" user="&iiasuser" pwd="&iiaspassword" readbuff=10000 INSERTBUFF=10000;

/* for report 1 MOR  */
LIBNAME FRG DB2 DATABASE="&IIASDB" SCHEMA="&FRG_USR" authdomain="IIAS_Auth" readbuff=10000 INSERTBUFF=10000;

/* for report 3 */
LIBNAME DM1P1D DB2 DATABASE="DM1U1D" SCHEMA="EDRRAP" authdomain=DB2U_AUTH readbuff=10000 INSERTBUFF=10000;
