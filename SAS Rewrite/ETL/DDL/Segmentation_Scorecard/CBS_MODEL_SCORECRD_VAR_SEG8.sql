...
drop table if exists CBS_MODEL_SCORECRD_VAR_SEG8;
CREATE EXTERNAL TABLE CBS_MODEL_SCORECRD_VAR_SEG8(
    CUST_CID                VARCHAR(40),
    OP_FIELD                VARCHAR(1000),
    INSRT_PROCESS_TMSTMP    TIMESTAMP,
    SEG_NUM                 INT               COMMENT 'CBS Model Segment Number. Defaulted to 8',
...
STORED AS ORC
LOCATION '/data/crz/bbcx/crz_cust_scorecard.db/CBS_MODEL_SCORECRD_VAR_SEG8'
