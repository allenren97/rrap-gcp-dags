...
# insert into table risk_txn_active_mappng table by adhoc

SQL1 = """
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table """ + cf.CBSDBName + """.risk_txn_active_mappng partition (eff_dt)
select 
...
from """ + cf.TSZRMADBName + """.cca_txn_active_mappng
where businesseffectivedate in (select max(businesseffectivedate) from """ + cf.TSZRMADBName + """.cca_txn_active_mappng)
"""
