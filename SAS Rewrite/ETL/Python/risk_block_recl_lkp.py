...
#===============================================================================
#
#         FILE: /app/bbcx_cbs_appid/ETL/python/risk_block_recl_lkp.py
#
#        USAGE: ./risk_block_recl_lkp.py 
#
...
# insert into table risk_block_recl_lkp table by adhoc

SQL1 = """
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table """ + cf.CBSDBName + """.risk_block_recl_lkp partition(eff_dt)
select 
  block_recl_cd
  ...
  ,bnkrpy_f
  ,cast(bnkrpy_f_desc as varchar(250))
  ,businesseffectivedate as eff_dt 
from """ + cf.TSZRMADBName + """.airb_block_recl_lkp
where businesseffectivedate in (select max(businesseffectivedate) from  """ + cf.TSZRMADBName + """.airb_block_recl_lkp )
"""
