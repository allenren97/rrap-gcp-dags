...
# insert into table risk_psnl_loan_scrty_prps_cd_lkp table by adhoc

SQL1 = """
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table """ + cf.CBSDBName + """.risk_psnl_loan_scrty_prps_cd_lkp partition (eff_dt)
select 
   prps_cd
...
from """ + cf.TSZRMADBName + """.cbs_psnl_loan_scrty_prps_cd_lkp a 
where businesseffectivedate in (select max(businesseffectivedate) from """ + cf.TSZRMADBName + """.cbs_psnl_loan_scrty_prps_cd_lkp)
"""
