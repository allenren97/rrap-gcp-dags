...
# insert into table risk_active_dlvy_origin_mappng table by adhoc

SQL1 = """
set hive.exec.dynamic.partition.mode=nonstrict;
insert overwrite table """ + cf.CBSDBName + """.risk_active_dlvy_origin_mappng partition (eff_dt)
select 
...
from """ + cf.TSZRMADBName + """.cca_active_dlvy_origin_mappng
where businesseffectivedate in (select max(businesseffectivedate) from """ + cf.TSZRMADBName + """.cca_active_dlvy_origin_mappng)
"""
